...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or manufacturer product identifier | CMP-DRX-50, CGS-EVAP-99, MWS-SOL-CRS |
| Product Name | product_name | text | — | yes | Full product name including type, grade, and production method | Compass Minerals DriRox Kiln-Dried Solar Salt, Cargill Top-Flo Evaporated Salt 99.9%, Morton Extra Coarse Solar Salt for Water Softening |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/drirox-solar-salt |
| Price | price | number | — | yes | Numeric price per unit (per tonne, per bag, or per pallet), excluding currency symbol | 45.00, 120.00, 350.00, 8.99 |

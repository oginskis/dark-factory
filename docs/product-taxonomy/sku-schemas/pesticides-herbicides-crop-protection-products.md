...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | SYN-ACURON-2.5GAL, BASF-PRIAXOR-2.5GAL, COR-DIM2EW |
| Product Name | product_name | text | — | yes | Full product name including brand, formulation, and package size | Acuron Herbicide 2.5 gal, Priaxor Xemium Fungicide, Dimension 2EW Herbicide |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/acuron-herbicide |
| Price | price | number | — | yes | Numeric price per unit excluding currency symbol | 42.95, 119.50, 289.00, 575.00 |

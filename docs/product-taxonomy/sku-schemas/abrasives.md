...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | SAIT-20063, 3M-90036, NOR66252940148 |
| Product Name | product_name | text | — | Full product name including type, size, grit, and grain | SAIT TrimBack Flap Disc 4.5in 60 Grit Zirconia, 3M Cubitron II Depressed Center Grinding Wheel 4.5x0.25 36+ |
| URL | url | text | — | Direct link to the product page | https://example.com/product/flap-disc-4-5-60-zirconia |
| Price | price | number | — | Numeric price per unit or per pack excluding currency symbol | 4.99, 12.50, 89.00 |

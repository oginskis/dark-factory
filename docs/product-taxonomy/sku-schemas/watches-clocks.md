...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | OMG-21030422, SEI-SWR054, CIT-BN0151-09L |
| Product Name | product_name | text | — | yes | Full product name including brand, collection, and key specs | Omega Seamaster Diver 300M Co-Axial Master Chronometer 42mm, Seiko Presage Automatic SPB167 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/seamaster-diver-300m |
| Price | price | number | — | yes | Numeric retail price excluding currency symbol | 175.00, 5400.00, 42500.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, GBP, EUR, JPY, CHF |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier, may include article number or reference code | WD-BLK-M-001, 77020365, E479071-000, 1310170003 |
| Product Name | product_name | text | — | yes | Full product name including brand, garment type, and key differentiators | Floral Wrap Midi Dress, Rayon Blouse, Long Printed Dress, Printed Shirt Dress |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/floral-wrap-midi-dress |
| Price | price | number | — | yes | Numeric retail price per unit, excluding currency symbol | 19.99, 49.99, 245.00 |

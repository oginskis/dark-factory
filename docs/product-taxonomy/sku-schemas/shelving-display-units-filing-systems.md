...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | H-2169BL, 695620, 80275887 |
| Product Name | product_name | text | — | yes | Full product name including type, dimensions, and key features | Lateral File Cabinet 36in Wide 4 Drawer Black, KALLAX Shelf Unit White 30x58in |
| URL | url | text | — | yes | Direct link to the product page | https://www.uline.com/Product/Detail/H-2169BL/Office-Storage/Lateral-File-Cabinet |
| Price | price | number | — | yes | Numeric unit price excluding currency symbol | 469.00, 89.99, 249.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or manufacturer product identifier | SKS-PET-BOS-8OZ, FHP-200CC-38, OBK-HDPE-32-JR |
| Product Name | product_name | text | — | yes | Full product name including container type, material, volume, and color | 8 oz Clear PET Boston Round Bottle, 200cc White HDPE Packer Bottle 38-400, 32 oz Natural HDPE Wide Mouth Jar |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/pet-boston-round-8oz-clear |
| Price | price | number | — | yes | Numeric price per unit or per case, excluding currency symbol | 0.35, 0.85, 12.50, 95.00 |

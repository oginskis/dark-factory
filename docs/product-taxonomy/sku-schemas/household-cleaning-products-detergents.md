...
| Brand | text | Manufacturer or brand name | Tide, Persil, Mrs. Meyers, Method, Seventh Generation, Clorox, Lysol, Dawn |
...
| Net Weight | number (g) | Net weight for powder or tablet products | 1420, 3630, 7200 |
...
| Load Count | number | Number of laundry loads per container for laundry products | 25, 64, 100, 110, 152 |
...
| PCR Content | text | Percentage of post-consumer recycled content in packaging | 25%, 30%, 50%, 100% |
| Certifications | text (list) | Product regulatory and quality certifications | EPA Safer Choice, USDA BioPreferred, Leaping Bunny, B Corp, Green Seal, ISO 14001 |
| Shelf Life | number (months) | Expected product shelf life from date of manufacture | 12, 24, 36 |
| Country of Origin | text | Country where the product is manufactured | USA, Germany, UK, Canada, Mexico |
| Safety Warnings | text (list) | Key safety warnings from the label | Keep Out of Reach of Children, Eye Irritant, Do Not Mix with Bleach |

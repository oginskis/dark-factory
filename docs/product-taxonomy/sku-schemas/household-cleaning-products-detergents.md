...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 5037629800, B07L67Z4CQ, 24434557 |
| Product Name | product_name | text | — | Full product name including brand, product line, variant, scent, and size | Tide Original Liquid Laundry Detergent 132 fl oz 100 Loads, Mrs. Meyers Lemon Verbena Multi-Surface Cleaner 16 oz |
| URL | url | text | — | Direct link to the product page | https://tide.com/en-us/shop/type/liquid/tide-original-liquid |
| Price | price | number | — | Numeric unit price excluding currency symbol | 12.97, 5.99, 24.99 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | E422992-000, FON0409WHT, T28/4960A, 143312924 |
| Product Name | product_name | text | — | yes | Full product name including brand, garment type, and key differentiators | Slim Fit Oxford Button-Down Shirt, Non-Iron Twill Spread Collar Shirt, Stretch Chino Pants |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/slim-fit-oxford-shirt |
| Price | price | number | — | yes | Numeric retail price per unit, excluding currency symbol | 14.90, 49.99, 129.00, 198.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, JPY, CAD, SEK |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | DC-WD2279LW, UF-4820, WR-288UT11 |
| Product Name | product_name | text | — | yes | Full product name including brand, garment type, and key features | Dickies Hi-Vis Lightweight Cotton Coverall, UniFirst Industrial Work Shirt, Workrite Tecasafe Plus FR Coverall |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/coverall-12345 |
| Price | price | number | — | yes | Numeric unit price excluding currency symbol | 29.99, 65.00, 189.50 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Seller or trading platform lot identifier | LOT-2026-03-0451, GRN-W-HRW-001, SOY-BR-2025 |
| Product Name | product_name | text | — | yes | Full commodity description including grain type, class, grade, and origin | US No. 2 Hard Red Winter Wheat, Brazilian Soybean Non-GMO, US No. 1 Yellow Corn |
| URL | url | text | — | yes | Direct link to the product listing or specification sheet | https://example.com/commodity/hrw-wheat-lot-451 |
| Price | price | number | — | yes | Numeric price per unit (bushel, metric ton, or hundredweight), excluding currency symbol | 5.85, 245.00, 14.50, 380.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, BRL, CAD, AUD, ARS |

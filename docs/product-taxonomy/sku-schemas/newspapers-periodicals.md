...
| Page Count | number | Total number of pages per typical issue (must be multiple of 4 for newspapers) | 48, 64, 96, 128, 200 |
| Column Count | number | Number of text columns per page in the standard editorial layout | 5, 6, 7, 8 |
| Paper Type | enum | Stock used for the interior pages | Newsprint, Coated Glossy, Coated Matte, Uncoated, Supercalendered |
| Paper Weight | number (gsm) | Basis weight of the interior paper stock | 42, 45, 52, 70, 90, 115 |
| Cover Paper Weight | number (gsm) | Basis weight of the cover stock for magazines and periodicals with separate covers | 170, 200, 250, 300 |
...
| Country of Printing | text | Country where the publication is physically printed | USA, UK, Germany, India, Australia |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | AW-400DH-3652, PEL-250-CS, MRV-ESS-AW |
| Product Name | product_name | text | — | yes | Full product name including key specs such as type, series, and size | Andersen 400 Series Double-Hung Window 36x52, Pella 250 Series Vinyl Casement |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/400-series-double-hung |
| Price | price | number | — | yes | Numeric price per unit, excluding currency symbol | 285.00, 549.99, 1250.00 |

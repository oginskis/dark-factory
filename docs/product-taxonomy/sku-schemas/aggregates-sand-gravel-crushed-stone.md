...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or quarry product identifier | AGG-57-GRN, SND-C33-WSH, GRV-PEA-NAT |
| Product Name | product_name | text | — | yes | Full product name including material type, size, and source | No. 57 Crushed Limestone, ASTM C33 Concrete Sand, 3/4 inch Pea Gravel Washed |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/57-crushed-stone |
| Price | price | number | — | yes | Numeric price per unit (per ton, per cubic yard, or per load) | 18.50, 32.00, 45.00, 120.00 |

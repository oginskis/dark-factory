...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | EPAC-SUP-8X10, GR-3SS-6X9, PPC-FLAT-5X7 |
| Product Name | product_name | text | — | yes | Full product name including format, material, and key dimensions | Metalized Stand-Up Pouch 8x10x3, Clear 3-Side-Seal Flat Pouch 6x9, Kraft Side-Gusset Bag 5x7x2 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/pouches/metalized-sup-8x10 |
| Price | price | number | — | yes | Numeric price per unit or per thousand, excluding currency symbol | 0.15, 0.45, 120.00, 350.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | 122115, LE-1275, SHELL-GR-EP2 |
| Product Name | product_name | text | — | yes | Full product name including brand, product line, grade, and formulation | Mobilgrease XHP 462 Moly, Shell Gadus S2 V220AC 2, Lubrication Engineers Almagard Vari-Purpose Lubricant |
| URL | url | text | — | yes | Direct link to the product data sheet or listing page | https://example.com/product/mobilgrease-xhp-462 |
| Price | price | number | — | yes | Numeric price per container, excluding currency symbol | 12.99, 89.50, 425.00 |

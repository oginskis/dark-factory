...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer article number or catalog identifier | 1C11, 1A1-2, 1C64, FC004R, PERSONA-TIB-09 |
| Product Name | product_name | text | — | yes | Full product name including type, model designation, and key differentiator | Terion K2 Prosthetic Foot, Persona Personalized Knee System, 4.0/5.0mm Cannulated Screw System, Empower Microprocessor Foot |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/terion-k2 |
| Price | price | number | — | yes | Numeric price per unit, excluding currency symbol | 4500.00, 12500.00, 85.00, 35000.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 223A, AE9DP100, WB12GT75, CC0025 |
| Product Name | product_name | text | — | yes | Full product name including brand, line, caliber, grain weight, and bullet type | Federal Power-Shok .223 Rem 55gr JSP, Hornady Precision Hunter 6.5 Creedmoor 143gr ELD-X, Winchester Super-X 12 Gauge 2-3/4 1oz #8 Shot |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/federal-223a |
| Price | price | number | — | yes | Numeric price per box excluding currency symbol | 14.99, 28.99, 41.99, 62.99, 129.99 |

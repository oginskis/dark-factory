...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 10-19188, FWD-WV-4420, MMI-T300 |
| Product Name | product_name | text | — | yes | Full product name including fabric type, composition, and key characteristics | 100% Cotton Poplin Solid White 58/60 in, Nomex IIIA Twill 6.0 oz FR Fabric, Organic Linen Chambray Natural 54 in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/cotton-poplin-12345 |
| Price | price | number | — | yes | Numeric price per unit of measure (yard, metre, or bolt) excluding currency symbol | 3.99, 12.50, 48.00 |

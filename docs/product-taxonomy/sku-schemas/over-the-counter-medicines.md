...
| Package Size | text | Quantity of dosage units or net contents per package | 100 Caplets, 24 Tablets, 4 FL OZ (118 mL), 1 OZ (28 g) |
...
| Warnings | text (list) | Key safety warnings required on the Drug Facts label | Liver Warning, Allergy Alert, Stomach Bleeding Warning, Do Not Use With Other Products Containing Acetaminophen |
| Drug Interaction Warnings | text (list) | Specific substances or drug classes to avoid while using the product | Alcohol, Blood Thinners, MAO Inhibitors, Other Pain Relievers/Fever Reducers |
...
| Tamper-Evident Feature | text | Type of packaging seal to indicate product integrity | Imprinted Foil Seal, Shrink Band, Breakaway Cap |

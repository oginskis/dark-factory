...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | SG-HEX-SA80, ZRCI-RS100, AE-AL2O3-PLATE |
| Product Name | product_name | text | Full product name including material, shape, and key specs | Hexoloy SA Silicon Carbide Beam 50x50x600mm, Alumina 99.5% Crucible 100ml |
| URL | url | text | Direct link to the product page | https://example.com/product/sic-beam-50x50x600 |
| Price | price | number | Numeric price per unit excluding currency symbol | 245.00, 89.50, 1200.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | SGT-800-62, CAT-C32-1100, C2750D6E, SST-800 |
| Product Name | product_name | text | — | yes | Full product name including model series and power rating | Siemens SGT-800 62 MW Gas Turbine, Caterpillar C32 1100 kW Diesel Generator Set, Cummins C2750D6E Centum Series |
| URL | url | text | — | yes | Direct link to the product page | https://www.siemens-energy.com/us/en/home/products-services/product/sgt-800.html |
| Price | price | number | — | yes | Numeric price per unit, excluding currency symbol | 85000, 210000, 5000000 |

...
| Brand | text | Manufacturer or brand name | Le Creuset, All-Clad, Lodge, Zwilling, Tramontina, Nordic Ware, USA Pan |
...
| Set Size | number | Total number of individual pieces in the selling unit, including lids | 1, 3, 7, 8, 10, 12 |
...
| Capacity | number (qt) | Interior liquid volume capacity in quarts | 1, 1.5, 2, 3, 4.5, 5.5, 6, 7.25, 8 |
| Diameter | number (inches) | Top rim diameter of the pan or pot in inches | 7.5, 8, 8.5, 9, 10, 10.25, 10.5, 12, 12.5, 15 |
...
| Weight | number (lbs) | Weight of the individual piece or complete set in pounds | 1.54, 2.8, 11.5, 19.84, 25 |
...
| Broiler Safe | boolean | Whether the cookware is safe to use under a broiler element | true, false |
| Country of Origin | text | Country where the cookware is manufactured | USA, France, China, Vietnam, Brazil, Italy, Belgium |
| Warranty | text | Duration or type of manufacturer warranty | Lifetime, Limited Lifetime, 10 Year, 25 Year |
| Certification | text (list) | Safety or quality certifications the cookware carries | NSF, ISO 9001 |
| PFOA Free | boolean | Whether the cookware is free of perfluorooctanoic acid | true, false |
| PTFE Free | boolean | Whether the cookware is free of polytetrafluoroethylene coatings | true, false |
| UPC | text | Universal Product Code barcode identifier | 728004493339, 024147001454 |

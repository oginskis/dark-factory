...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | UL-S4040404, BER-v4400K01, PCA-RSC-2412 |
| Product Name | product_name | text | — | yes | Full product name including key dimensions and construction type | 32 ECT Single Wall RSC 12x10x6, Double Wall Heavy Duty Box 24x18x18, White Corrugated Mailer 11x8x4 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/boxes/rsc-12x10x6 |
| Price | price | number | — | yes | Numeric price per unit or per bundle, excluding currency symbol | 0.85, 7.02, 70.58 |

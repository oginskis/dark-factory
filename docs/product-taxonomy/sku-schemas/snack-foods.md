...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or distributor product identifier | 999CHIP001, SNK-LAY-24, 103MART0016 |
| Product Name | product_name | text | — | Full product name including key descriptors such as type, flavor, and pack configuration | Martin's Sea Salt Potato Chips 1 oz. - 30/Case, Herr's Sour Cream and Onion Rippled Chips 2.75 oz. - 24/Case |
| URL | url | text | — | Direct link to the product page | https://example.com/product/sea-salt-chips-30pk |
| Price | price | number | — | Numeric price per selling unit (case, box, or individual), excluding currency symbol | 18.99, 24.50, 42.95 |

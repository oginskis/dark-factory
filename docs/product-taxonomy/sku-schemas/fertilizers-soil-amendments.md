...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | DTE-ALFALFA-5LB, FDC-NUTRIVEG-25, BW-PAR4-50 |
| Product Name | product_name | text | — | yes | Full product name including brand, formulation, and size | Down To Earth Alfalfa Meal 5 lb, Fedco NutriVeg 5-4-4 Organic Fertilizer 25 lb, Espoma Garden-tone 3-4-4 18 lb |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/alfalfa-meal-5lb |
| Price | price | number | — | yes | Numeric price per unit excluding currency symbol | 8.99, 14.50, 32.95, 89.00 |

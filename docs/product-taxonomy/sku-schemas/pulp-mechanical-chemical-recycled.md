...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | NBSK-GP-001, SUZ-EB-500, IP-SBSK-200 |
| Product Name | product_name | text | — | yes | Full commercial product name including grade and fiber origin | Suzano Eucabright BHKP, GP Cellulose NBSK Premium, Mercer Rosenthal BCTMP |
| URL | url | text | — | yes | Direct link to the product page or datasheet | https://example.com/products/nbsk-premium |
| Price | price | number | — | yes | Numeric price per metric tonne, excluding currency symbol | 678.00, 520.50, 1150.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, CNY, BRL |

...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Supplier or manufacturer product identifier | REE-NdOx-4N-1KG, AEM-Dy-5N-500G, MSE-CeO2-5N |
| Product Name | product_name | text | — | Full product name including element, compound type, purity, and form | Neodymium Oxide (Nd2O3) 99.99% 4N Powder, Dysprosium Metal 99.999% 5N Ingot, Cerium Oxide Polishing Grade 98% TREO |
| URL | url | text | — | Direct link to the product page | https://example.com/products/neodymium-oxide-4n |
| Price | price | number | — | Numeric price per unit (per kg, per g, or per package), excluding currency symbol | 45.00, 250.00, 1800.00, 5500.00 |
| Currency | currency | text | — | ISO 4217 currency code | USD, EUR, CNY, JPY |

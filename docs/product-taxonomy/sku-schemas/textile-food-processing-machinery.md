...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | GEA-CG1500, 4146-SS, R37-600, LMW-LK64 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as machine type, model, and capacity | GEA ComboGrind 1500/250 Industrial Meat Grinder, Rieter R 37 Rotor Spinning Machine 600 Positions |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/combogrind-1500 |
| Price | price | number | — | yes | Numeric price per unit excluding currency symbol | 85000, 245000, 1250000 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, CHF, INR |

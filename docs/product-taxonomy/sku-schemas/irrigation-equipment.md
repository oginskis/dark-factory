...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or retailer product identifier, article number, or part number | 970545901, 900978801, PGJ-04 |
| Product Name | product_name | text | — | yes | Full product name including model designation and key specs | I-20 Stainless Steel Rotor, Classic Circular Sprinkler Samba, UniRam AS XR 16mm |
| URL | url | text | — | yes | Direct link to the product page or catalog listing | https://example.com/products/sprinklers/i-20.html |
| Price | price | number | — | yes | Numeric price value without currency symbol | 24.99, 149.00, 0.85 |

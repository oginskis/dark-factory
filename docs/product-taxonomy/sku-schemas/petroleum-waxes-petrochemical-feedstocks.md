...
| FDA Approved | boolean | Whether the wax grade is approved for food contact per FDA 21 CFR 172.886 or 178.3710 | true, false |
| REACH Registered | boolean | Whether the product is registered under EU REACH regulation | true, false |
| Kosher Certified | boolean | Whether the product has kosher certification | true, false |
| Physical Form | enum | Form in which the product is sold | Slab, Pellet, Pastille, Flake, Liquid, Bulk Liquid |
| Packaging | text | Container or packaging type and size | 50 lb slab case, 25 kg bag, 180 kg drum, ISO tank, Bulk tanker |
| Application | text (list) | Primary intended industrial uses | Candle Making, Food Coating, Cosmetics, Rubber Compounding, Adhesives, Steam Cracking, Reforming, Aromatics Extraction |
| Applicable Standard | text (list) | Specification standards the product meets | ASTM D87, ASTM D127, ASTM D721, ASTM D86, FDA 21 CFR 178.3710, EN 14175 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 14926, PRO-PLN-CHK-35, B07DC8BR3B |
| Product Name | product_name | text | — | yes | Full product name including brand, product line, protein, and size | Purina Pro Plan Adult Chicken and Rice 35 lb, Blue Buffalo Wilderness Salmon Cat Food 12 lb, Frontline Plus for Dogs |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/dog-food-chicken-35lb |
| Price | price | number | — | yes | Numeric price per package or unit, excluding currency symbol | 9.99, 34.98, 64.99 |

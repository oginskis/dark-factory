...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | UFP-STR-4840, PECO-GMA-48, PLT1-BLK-4840-HT |
| Product Name | product_name | text | — | yes | Full product name including type, size, and treatment | 48x40 GMA Block Pallet Heat-Treated, Custom Stringer Pallet 48x48 Softwood |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/gma-block-pallet-48x40 |
| Price | price | number | — | yes | Numeric price per pallet or per unit excluding currency symbol | 8.50, 15.00, 32.00, 65.00 |

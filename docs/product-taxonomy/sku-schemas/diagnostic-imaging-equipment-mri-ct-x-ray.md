...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer model number or catalog identifier | SIGNA Premier, SOMATOM Force, Alphenix 4D CT |
| Product Name | product_name | text | — | yes | Full product name including modality and key differentiator | GE SIGNA Premier 3.0T Wide Bore MRI, Siemens SOMATOM go.Up 64-Slice CT, Canon Radrex i5 Digital Radiography System |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/signa-premier |
| Price | price | number | — | yes | Numeric list or quoted price per system, excluding currency symbol | 1500000, 850000, 250000 |

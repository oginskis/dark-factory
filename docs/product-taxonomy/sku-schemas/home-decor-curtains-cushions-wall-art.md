...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | WC-8432-NVY, DD-CUR-120, ART-CVS-3624 |
| Product Name | product_name | text | Full product name including key specs such as type, material, and dimensions | Eclipse Blackout Curtain Panel 52x84 in Navy, Sunbrella Outdoor Throw Pillow 20x20 in Natural, Abstract Canvas Wall Art Set of 3 24x36 in |
| URL | url | text | Direct link to the product page | https://example.com/product/blackout-curtain-navy |
| Price | price | number | Numeric price per unit or per set excluding currency symbol | 14.99, 39.00, 89.95, 245.00 |

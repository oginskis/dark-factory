...
|-----------|-----------|-------------|----------------|
| SKU | text | Unique product identifier or article number assigned by manufacturer or retailer | FG572024CLR, 11233400, 19567111, 1139099 |
| Product Name | text | Full product name including brand, line, and capacity descriptor | CamSquare 4 Qt Clear Square Polycarbonate Food Storage Container, Simply Store 6-Piece Glass Storage Set, One Touch Fresh Rectangular 12 Cup |
...
| Oven Safe | boolean | Whether the container is safe for use in a conventional oven | true, false |
| Temperature Range Min | number (F) | Minimum safe operating or storage temperature in Fahrenheit | -40, -13, 32 |
| Temperature Range Max | number (F) | Maximum safe operating or storage temperature in Fahrenheit | 150, 210, 572 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Unique product identifier or article number assigned by manufacturer or retailer | FG572024CLR, 11233400, 19567111, 1139099 |
| Product Name | product_name | text | — | yes | Full product name including brand, line, and capacity descriptor | CamSquare 4 Qt Clear Square Polycarbonate Food Storage Container, Simply Store 6-Piece Glass Storage Set, One Touch Fresh Rectangular 12 Cup |
| URL | url | text | — | yes | Direct link to the product page or listing on the manufacturer or retailer website | https://www.rubbermaidcommercial.com/foodservice/food-storage/round-storage-containers/ |
| Price | price | number | — | yes | Unit price of the container or set, excluding tax and shipping | 8.29, 13.00, 24.00, 11.99, 27.49 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | BES-6.5-325, FCgen-HPS-140, GS-MW-1000 |
| Product Name | product_name | text | — | yes | Full product name including model, technology type, and power rating | Bloom Energy Server 6.5 325 kW, Ballard FCgen-HPS 140 kW Stack, Plug Power GenSure MW-Scale 1 MW |
| URL | url | text | — | yes | Direct link to the product page | https://www.bloomenergy.com/technology/ |
| Price | price | number | — | yes | Numeric price per unit or per kW, excluding currency symbol | 750000, 1200000, 5000 |

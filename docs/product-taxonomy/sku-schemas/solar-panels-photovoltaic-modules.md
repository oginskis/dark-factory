...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | LR7-72HGD-615M, LR5-72HPH-555M, JAM72S30-545 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as brand, wattage, and technology | LONGi Hi-MO 7 615W Bifacial N-Type Module, JA Solar DeepBlue 3.0 545W Mono PERC |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/hi-mo-7-615w |
| Price | price | number | — | yes | Numeric price per unit (per module) excluding currency symbol | 189.00, 245.50, 310.00, 0.18 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, AUD, CNY |

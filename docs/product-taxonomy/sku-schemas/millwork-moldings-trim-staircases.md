...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | MFP620, MO-CAS-612, BLDR-WM327 |
| Product Name | product_name | text | — | yes | Full product name including profile type, species, and dimensions | 1/2in x 4-1/4in x 16ft Primed MDF Baseboard, Poplar Colonial Casing 11/16 x 2-1/4 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/primed-mdf-baseboard-4-25 |
| Price | price | number | — | yes | Numeric price per linear foot or per piece excluding currency symbol | 1.81, 3.49, 12.99 |

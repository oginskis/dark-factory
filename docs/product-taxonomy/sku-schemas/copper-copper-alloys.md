...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | CU110-RB-0500, C260-SHT-032 |
| Product Name | product_name | text | — | yes | Full product name including alloy, form, and dimensions | C11000 ETP Copper Round Bar 0.5in x 36in, C26000 Cartridge Brass Sheet 0.032in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/c11000-copper-round-bar |
| Price | price | number | — | yes | Numeric unit price (per piece, per foot, or per pound) excluding currency symbol | 24.50, 78.95, 5.60 |

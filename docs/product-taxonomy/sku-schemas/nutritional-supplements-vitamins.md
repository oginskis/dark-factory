...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | SWU252, NOW-0372, IHB-87432 |
| Product Name | product_name | text | Full product name including key active ingredient, strength, and form | Vitamin D3 5000 IU Softgels, Magnesium Glycinate 400 mg Capsules, Omega-3 Fish Oil 1000 mg |
| URL | url | text | Direct link to the product page | https://example.com/products/vitamin-d3-5000iu |
| Price | price | number | Numeric price per unit of sale, excluding currency symbol | 12.99, 24.50, 8.75 |

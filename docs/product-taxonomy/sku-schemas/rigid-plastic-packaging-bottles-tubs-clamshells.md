...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | TB-027123, VP-CS-200, IND-TR-4X6 |
| Product Name | product_name | text | — | yes | Full product name including capacity, material, and format | 12 oz Natural HDPE Cylinder Round Bottle 38-400, Clear PET Clamshell 6x4x2, White PP Tub 16 oz with Lid |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/bottles/hdpe-12oz-cylinder |
| Price | price | number | — | yes | Numeric price per unit or per case, excluding currency symbol | 0.22, 0.85, 45.00, 120.00 |

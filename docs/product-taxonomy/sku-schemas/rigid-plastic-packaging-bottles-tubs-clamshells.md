...
|-----------|-----------|-------------|----------------|
| SKU | text | Manufacturer or distributor product identifier | TB-027123, VP-CS-200, IND-TR-4X6 |
| Product Name | text | Full product name including capacity, material, and format | 12 oz Natural HDPE Cylinder Round Bottle 38-400, Clear PET Clamshell 6x4x2, White PP Tub 16 oz with Lid |
...
| Closure Included | enum | Whether a matching closure or lid is supplied with the container | Yes, No, Sold Separately |
| Tamper Evidence | enum | Type of tamper-evident feature if present | None, Shrink Band, Break-Away Ring, Induction Seal, Snap Lock, Peel Tab |
| Food Contact Compliance | enum | Whether the container meets food-contact safety requirements | FDA 21 CFR, EU 10/2011, Not Food Grade |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | GT-315W, NW-8oz, HT-200PP |
| Product Name | product_name | text | — | yes | Full product name including key specs such as type, weight, and strength class | Woven Polypropylene Geotextile 315 lbs Grab Tensile, Nonwoven Polyester Filter Fabric 8 oz |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/woven-geotextile-315 |
| Price | price | number | — | yes | Numeric price per unit (per square yard, linear foot, or roll), excluding currency symbol | 0.45, 2.80, 350.00, 1200.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | MPC-PG6422, TB-60/70, AI-CRS2 |
| Product Name | product_name | text | — | yes | Full product name including manufacturer, product type, and grade | Marathon PG 64-22 Paving Grade Asphalt, Tiger Bitumen Penetration Grade 60/70, CRS-2 Cationic Rapid-Setting Emulsion |
| URL | url | text | — | yes | Direct link to the product data sheet or listing page | https://example.com/product/pg-64-22-asphalt |
| Price | price | number | — | yes | Numeric price per ton or gallon, excluding currency symbol | 450.00, 625.00, 3.25 |

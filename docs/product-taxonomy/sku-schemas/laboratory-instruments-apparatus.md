...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor catalog/part number | 75009513, G1312C, 5065-4401, 022620601 |
| Product Name | product_name | text | — | yes | Full product name including brand, model, and key specification | Thermo Scientific SL4 Plus Centrifuge 120V, Agilent 1260 Infinity II Quaternary Pump, Eppendorf Centrifuge 5430 R |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/sl4-plus-centrifuge |
| Price | price | number | — | yes | List or catalog price per unit | 850, 4500, 12000, 45000, 125000 |

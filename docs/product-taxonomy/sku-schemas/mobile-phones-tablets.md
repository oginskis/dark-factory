...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | SM-S928BZKDEUB, MWXF3LL/A, GA06157-US |
| Product Name | product_name | text | — | Full product name including brand, model, storage, and color | Samsung Galaxy S25 Ultra 512GB Titanium Black, Apple iPhone 16 Pro Max 256GB, Google Pixel 9 Pro 128GB |
| URL | url | text | — | Direct link to the product page | https://example.com/product/galaxy-s25-ultra |
| Price | price | number | — | Numeric unit price excluding currency symbol | 799.99, 1199.00, 449.95 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | S-423, 372, IPG-HM-2x110 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as type, width, and adhesive | 3M Scotch 372 Performance Box Sealing Tape 48mm x 50m, Polyester Strapping 1/2 in x 3250 ft, Bubble Cushioning Roll 12 in x 175 ft |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/box-sealing-tape-372 |
| Price | price | number | — | yes | Numeric price per unit or per roll/case excluding currency symbol | 4.29, 58.50, 124.00 |

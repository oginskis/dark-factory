...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | DSBC-40-160-PPVA-N3, CQ2B25-10D, HY08-1117 |
| Product Name | product_name | text | — | Full product name including type, series, bore, and stroke | Festo DSBC Standard Cylinder 40mm Bore 160mm Stroke, SMC CQ2 Compact Pneumatic Cylinder 25mm x 10mm |
| URL | url | text | — | Direct link to the product page | https://example.com/product/dsbc-40-160 |
| Price | price | number | — | Numeric unit price excluding currency symbol | 85.50, 245.00, 1250.00 |

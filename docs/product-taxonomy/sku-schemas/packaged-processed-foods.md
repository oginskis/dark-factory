...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 041303010747, WMT-98765, SYS-4820031 |
| Product Name | product_name | text | — | Full product name including brand, variety, and size | Campbell's Condensed Tomato Soup 10.75 oz, Heinz Baked Beans 415g, Del Monte Sliced Peaches in Light Syrup 15.25 oz |
| URL | url | text | — | Direct link to the product page | https://example.com/product/campbells-tomato-soup |
| Price | price | number | — | Numeric price per selling unit (can, jar, case), excluding currency symbol | 1.29, 24.99, 3.49 |

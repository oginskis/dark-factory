...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer, wholesaler, or specialty pharmacy product identifier | PFZ-BIO-4012, ABI-HUM-40, SPH-RIT-100 |
| Product Name | product_name | text | — | yes | Full product name including brand name, active substance, strength, and presentation | Humira 40 mg/0.4 mL Prefilled Syringe, Avastin 400 mg/16 mL Injection, Hadlima 40 mg/0.8 mL Pen |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/humira-40mg-syringe |
| Price | price | number | — | yes | Numeric price per unit or per package excluding currency symbol | 1289.00, 6780.50, 450.25 |

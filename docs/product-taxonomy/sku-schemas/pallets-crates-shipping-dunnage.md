...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | H-1260, 239866, CPP336ACM |
| Product Name | product_name | text | — | yes | Full product name including key specs such as material, size, and type | Heat Treated Wood GMA Pallet 48 x 40, Double Deck Plastic Pallet 4-Way Entry 48 x 40, Hardwood Dunnage 4x4x48 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/gma-pallet-48x40 |
| Price | price | number | — | yes | Numeric price per unit excluding currency symbol | 67.95, 12.50, 245.00 |

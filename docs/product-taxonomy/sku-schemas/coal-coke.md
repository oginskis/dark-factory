...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Supplier or trader product identifier | MET-HCC-01, THM-5500-LV, COKE-MET-60 |
| Product Name | product_name | text | — | Full product name including type, grade, and key specs | BMA Peak Downs Hard Coking Coal, South African RB1 Thermal Coal 6000 kcal, Metallurgical Coke CSR 65 |
| URL | url | text | — | Direct link to the product page | https://example.com/products/met-coal-hcc |
| Price | price | number | — | Numeric price per metric tonne, excluding currency symbol | 180.00, 95.50, 320.00 |

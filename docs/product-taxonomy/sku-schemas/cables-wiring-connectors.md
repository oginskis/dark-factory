...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 1746244, WM1234-ND, 174-6244 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as type, gauge, and conductor count | 3-Core 1.5mm PVC Flex Cable Black 10m, Cat6 UTP Ethernet Patch Cable 5ft Blue |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/multi-core-cable-1-5mm |
| Price | price | number | — | yes | Numeric price per unit (metre, foot, reel, or piece depending on seller), excluding currency symbol | 0.85, 12.50, 249.99 |

...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | SHM-4805, STA-0472, ABU-REVO5X, PEN-BTLIII5000 |
| Product Name | product_name | text | — | Full product name including brand, model series, and key differentiating specs | Shimano Stradic FM 3000XG Spinning Reel, Star Rods Stellar Surf Spinning Rod 12ft, Rapala X-Rap Saltwater 10 Crankbait |
| URL | url | text | — | Direct link to the product page | https://example.com/product/stradic-fm-3000xg |
| Price | price | number | — | Numeric retail price per unit excluding currency symbol | 39.99, 149.95, 254.99, 449.99 |
| Currency | currency | text | — | ISO 4217 currency code | USD, GBP, EUR, JPY, CAD, AUD |

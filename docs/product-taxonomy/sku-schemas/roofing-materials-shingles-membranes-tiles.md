...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | OC-DUR-DW, GAF-TS-HDZ, FS-UPTPO60 |
| Product Name | product_name | text | Full product name including type, product line, and color or size | Owens Corning TruDefinition Duration Driftwood, GAF Timberline HDZ Charcoal, Firestone UltraPly TPO 60 mil |
| URL | url | text | Direct link to the product page | https://example.com/product/oc-duration-driftwood |
| Price | price | number | Numeric price per bundle, per square, per roll, or per tile, excluding currency symbol | 32.00, 98.00, 245.00, 1.85 |

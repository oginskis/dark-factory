...
| Copper Weight Outer | number (oz) | Weight of copper per square foot on outer layers of the PCB | 0.5, 1, 2, 3 |
| Copper Weight Inner | number (oz) | Weight of copper per square foot on inner layers of the PCB | 0.5, 1, 2 |
...
| Minimum Drill Size | number (mm) | Smallest finished hole diameter available | 0.15, 0.2, 0.3 |
| Board Dimensions Length | number (mm) | Length of the finished PCB | 20, 50, 100, 300, 600 |
...
| Voltage Rating | number (V) | Maximum continuous voltage the component can withstand | 10, 16, 25, 50, 100, 250 |
| Current Rating | number (A) | Maximum continuous current the component can carry | 0.5, 1.0, 3.0, 10.0, 20.0 |
| Power Rating | number (W) | Maximum power the component can dissipate | 0.0625, 0.125, 0.25, 0.5, 1.0 |
| Package Size | text | Standard component package size code | 0201, 0402, 0603, 0805, 1206, 1210, 2512 |
| Mounting Type | enum | Method by which the component is attached to the PCB | Surface Mount (SMD), Through Hole (THT), Press Fit |
| Pin Count | number | Number of pins, leads, or contacts on the component | 2, 4, 8, 14, 20, 24, 40 |
| Pin Pitch | number (mm) | Center-to-center distance between adjacent pins or contacts | 0.5, 0.65, 1.0, 1.27, 2.0, 2.54 |
| Operating Temperature Min | number (C) | Lower bound of the operating temperature range | -55, -40, -20, 0 |
| Operating Temperature Max | number (C) | Upper bound of the operating temperature range | 85, 105, 125, 150 |
...
| UL Certification | text | Underwriters Laboratories flammability and safety rating | UL 94V-0, UL Listed, UL Recognized |
...
| Lead Time | number (days) | Typical manufacturing or delivery lead time | 1, 3, 5, 7, 14, 21 |
| Minimum Order Quantity | number | Minimum number of units or boards per order | 1, 5, 10, 100, 1000 |

...
| Brand/Manufacturer | text | Equipment or consumable manufacturer name | Lincoln Electric, Miller, ESAB, Fronius, Hobart, Hypertherm, Victor, Harris |
...
| Input Voltage | text | Required input power voltage | 120V, 208/230V, 230/460V, 120/230V Dual |
...
| Wire Diameter Range | text | Compatible wire or electrode diameters | 0.023-0.035 in, 0.6-1.0 mm, 0.030-0.045 in, 3/32-5/32 in |
...
| Spool Size/Weight | text | Wire spool or rod package weight | 2 lb, 10 lb, 33 lb, 44 lb, 50 lb, 60 lb |
...
| Weight | number (lbs) | Net weight of equipment or package | 50, 79, 105, 185, 10, 33 |
| Cooling Method | enum | Method of thermal management | Fan Cooled, Water Cooled, Natural Convection |
| Display Type | text | Control panel display technology | Digital LED, LCD, Analog Meter, None |
| Torch/Gun Included | boolean | Whether a welding torch or gun is included with the machine | Yes, No |
| Torch Rating | text | Duty cycle and amperage rating of included torch | 150A/60%, 300A/100%, 200A/60% |
| IP Rating | text | Ingress protection rating of the equipment enclosure | IP21, IP23, IP23S |
| Certifications | text (list) | Safety and compliance certifications | CSA, UL, CE, CCC, S-mark, EN 60974 |
| Warranty | text | Manufacturer warranty duration | 3 years, 5 years, 3 years parts/1 year labor |

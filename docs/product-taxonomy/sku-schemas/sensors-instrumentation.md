...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | PX309-100GI, TMP36GT9Z, 52PG26 |
| Product Name | product_name | text | — | Full product name including key specs such as sensor type, range, and output | IFM Digital Pressure Sensor SPST 0-3620 psi, Pt100 RTD Probe 4-Wire 300mm |
| URL | url | text | — | Direct link to the product page | https://example.com/product/pressure-transducer-px309 |
| Price | price | number | — | Numeric price per unit, excluding currency symbol | 5.60, 89.50, 425.00 |

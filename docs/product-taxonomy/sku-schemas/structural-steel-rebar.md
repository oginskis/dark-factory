...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | MU-RB5-20, SS-W8X31, KM-A992-W10 |
| Product Name | product_name | text | — | yes | Full product name including product type, grade, and size | No. 5 Grade 60 Rebar 20 ft, W8x31 A992 Wide Flange Beam, A36 Angle 3 x 3 x 1/4 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/rebar-5-grade60-20ft |
| Price | price | number | — | yes | Numeric price per piece, per foot, or per ton, excluding currency symbol | 12.50, 45.00, 850.00 |

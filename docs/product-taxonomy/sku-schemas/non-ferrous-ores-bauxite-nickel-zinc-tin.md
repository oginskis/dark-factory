...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or trader product identifier | BAU-MET-A44, NiC-LAT-15, ZnC-58-HG, SnC-CAS-70 |
| Product Name | product_name | text | — | yes | Full product name including ore type, grade, and key specs | Rawmin Metallurgical Grade A Bauxite 44% Al2O3, Laterite Nickel Ore 1.5% Ni, Zinc Concentrate 58% Zn, Cassiterite Tin Concentrate 70% Sn |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/bauxite-met-grade-a |
| Price | price | number | — | yes | Numeric price per dry metric tonne (ore/concentrate) or per lb (refined metal reference), excluding currency symbol | 35.00, 85.00, 120.00, 2800.00 |

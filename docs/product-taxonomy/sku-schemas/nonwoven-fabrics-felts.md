...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | PE-15-60, F3-1/4, NW-PP-200 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as material, weight, and thickness | SAE F-3 Wool Felt 1/4in Grey, Polyester Needlepunch 400 GSM Black |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/sae-f3-wool-felt |
| Price | price | number | — | yes | Numeric price per unit (per square yard, linear yard, or sheet), excluding currency symbol | 12.50, 28.00, 85.00 |

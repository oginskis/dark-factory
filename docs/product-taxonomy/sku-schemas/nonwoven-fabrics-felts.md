...
| Brand/Manufacturer | text | Manufacturer or supplier name | Superior Felt, US Felt, Monarch Textiles, Sutherland Felt, Bouckaert Industrial Textiles |
...
| Weight Oz | number (oz/yd2) | Mass per unit area in ounces per square yard | 2, 6, 14.75, 29.5, 48 |
...
| Roll Length | number (yd) | Standard roll length in yards | 25, 50, 100, 200 |
...
| Certification | text (list) | Compliance and quality certifications | ISO 9001, UL Listed, FDA Grade, RoHS, REACH |
| Country of Origin | text | Country where the material was manufactured | USA, Germany, China, India |
| Minimum Order Quantity | number | Minimum purchase quantity | 1, 5, 10, 50 |
| Selling Unit | enum | Unit of measure for pricing and ordering | Linear Yard, Square Yard, Sheet, Roll |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | 4225B11-B, ARD-12HRT-AG, OI-750BG-FL |
| Product Name | product_name | text | — | yes | Full product name including key specs such as container type, capacity, and color | 16oz Clear Glass French Square Bottle, Ardagh 12oz Heritage Amber Beer Bottle, O-I 750ml Flint Bordeaux Wine Bottle |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/16oz-french-square |
| Price | price | number | — | yes | Numeric price per unit or per case, excluding currency symbol | 0.35, 0.72, 1.50, 52.00 |

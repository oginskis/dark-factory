...
|-----------|-----------|-------------|----------------|
| SKU | text | Manufacturer or distributor product identifier | 4225B11-B, ARD-12HRT-AG, OI-750BG-FL |
| Product Name | text | Full product name including key specs such as container type, capacity, and color | 16oz Clear Glass French Square Bottle, Ardagh 12oz Heritage Amber Beer Bottle, O-I 750ml Flint Bordeaux Wine Bottle |
...
| Case Pack Quantity | number | Number of containers per case or carton | 6, 12, 24, 36, 40, 48, 72 |
| Pallet Quantity | number | Number of containers per full pallet | 600, 1200, 1800, 2200, 3600 |
| FDA Food Contact | boolean | Whether the container is FDA compliant for food/beverage contact | true, false |
| Recyclable | boolean | Whether the container is recyclable in standard glass streams | true, false |

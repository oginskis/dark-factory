...
| Brand/Manufacturer | text | Mineral producer or supplier name | Imerys, U.S. Silica, Micronized, Active Minerals International, BASF Minerals |
...
| Particle Size (Median) | number (um) | D50 median particle diameter in micrometres | 1.5, 4.0, 10.0, 45.0, 150.0 |
| Mesh Grade | text | US standard sieve mesh size designation | 100, 200, 325, 400, 500, 1500 |
| Top Cut Size | number (um) | Maximum particle size in the product (D98 or D100) | 10, 20, 45, 75, 150, 500 |
...
| CAS Number | text | Chemical Abstracts Service registry number | 14808-60-7, 1332-58-7, 14807-96-6, 13462-86-7 |
| Bulk Density | number (g/cm3) | Loose or tapped bulk density of the powder or granule product | 0.30, 0.50, 0.80, 1.20, 1.50 |

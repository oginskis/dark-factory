...
| Brand/Manufacturer | text | Jewelry brand or designer name | Pandora, Kendra Scott, Swarovski, BaubleBar, Gorjana, Mejuri |
...
| Chain Length | text (inches) | Length of necklace chain, may include multiple options | 15, 16-18 adjustable, 20, 30, Choker 14 |
| Bracelet Length | text (inches) | Inner circumference or adjustable range of bracelet | 6.3, 7.5, 6-8 adjustable |
| Ring Size | text | Ring finger size using the applicable regional scale | 5, 6, 7, 8, One Size |
...
| Weight | number (g) | Total weight of the finished piece | 3.50, 8.20, 15.00, 28.60 |
...
| Warranty Period | text | Duration of manufacturer warranty against defects | 1 Year, 2 Years, Lifetime |

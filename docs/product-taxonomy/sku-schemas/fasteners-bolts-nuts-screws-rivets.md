...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | HCS-38-16X2-GR5-ZN, SS-10-32-FH-18-8 |
| Product Name | product_name | text | — | yes | Full product name including type, size, material, and finish | Grade 5 Hex Cap Screw 3/8-16 x 2in Zinc Plated, 18-8 Stainless Steel Flat Head Machine Screw 10-32 x 1in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/gr5-hex-cap-screw-3-8-16x2 |
| Price | price | number | — | yes | Numeric unit price (per piece or per box/bag) excluding currency symbol | 0.12, 4.50, 18.99 |

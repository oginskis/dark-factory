...
| Brand/Manufacturer | text | Company producing or supplying the labels or tags | Avery Dennison, Discount Labels, IndustriTAG, Badger Tag and Label, Chicago Tag and Label |
...
| Liner Weight | number (lb) | Basis weight of the liner stock | 40, 50, 60 |
...
| Roll Core Diameter | number (in) | Inner core diameter for roll-form labels | 1, 1.5, 3, 6 |
...
| Attachment Method | text | How the tag is fastened to the product (tags only) | String, Wire, Elastic, Adhesive, Metal Eyelet, Self-Locking Loop, Pin |
| Certification | text (list) | Regulatory and safety certifications for the label product | UL Recognized, CSA, FDA Compliant, RoHS, REACH, GHS Compliant |
| Minimum Order Quantity | number | Smallest quantity available for purchase | 100, 250, 500, 1000, 5000 |

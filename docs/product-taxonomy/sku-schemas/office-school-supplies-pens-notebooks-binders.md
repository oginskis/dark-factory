...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 50786-CC, ST63315, 2498023 |
| Product Name | product_name | text | — | Full product name including brand, type, and key specification | Staples Retractable Ballpoint Pen Fine 0.7mm Black Dozen, Five Star 3-Subject Notebook College Ruled 150 Sheets, Avery Heavy-Duty 3-Ring Binder 2 Inch |
| URL | url | text | — | Direct link to the product page | https://example.com/product/ballpoint-pen-fine-black |
| Price | price | number | — | Numeric price per unit or pack, excluding currency symbol | 3.49, 8.99, 12.49 |

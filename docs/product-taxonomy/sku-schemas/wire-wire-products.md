...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or distributor product identifier | NW-BW-12GA-100, CW-SS316-010 |
| Product Name | product_name | text | Full product name including material, type, gauge, and packaging | 12 Gauge Galvanized Steel Baling Wire 100lb Coil, 316L Stainless Steel Fine Wire 0.010in Spool |
| URL | url | text | Direct link to the product page | https://example.com/product/12ga-galvanized-baling-wire |
| Price | price | number | Numeric unit price (per spool, per coil, per foot, or per pound) excluding currency symbol | 45.00, 89.95, 0.35, 2.80 |

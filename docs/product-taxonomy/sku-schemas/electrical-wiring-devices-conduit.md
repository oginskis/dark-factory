...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | LEV-5320-WMP, HBL-5362I, CAN-A40AEB |
| Product Name | product_name | text | — | yes | Full product name including key specs such as device type, rating, and color | Leviton 20A 125V Duplex Receptacle White, Hubbell Snap-Connect 15A Toggle Switch, Cantex Schedule 40 PVC Conduit 1in x 10ft |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/20a-duplex-receptacle |
| Price | price | number | — | yes | Numeric price per unit, excluding currency symbol | 1.29, 4.75, 12.99, 38.50 |

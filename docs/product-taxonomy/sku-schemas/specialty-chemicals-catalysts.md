...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier catalog number or product identifier | 908126, 330108, KATALCO-51-102, Noblyst-P1159 |
| Product Name | product_name | text | — | yes | Full product name including active component, support, and loading | Evonik Noblyst P1159 5% Pd on Alumina powder, BASF KATALCO 51-102 Methanol Synthesis Catalyst, Johnson Matthey 5% Palladium on Carbon |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/catalysts/noblyst-p1159 |
| Price | price | number | — | yes | Numeric price per package unit excluding currency symbol | 85.00, 350.00, 1250.00 |

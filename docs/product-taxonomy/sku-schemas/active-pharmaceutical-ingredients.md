...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or manufacturer catalog identifier | B0005-464900, API-1234, DR-ABR-001 |
| Product Name | product_name | text | — | yes | International Non-proprietary Name (INN) or common chemical name of the API | Abiraterone Acetate, Metformin Hydrochloride, Ibuprofen |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/api/abiraterone-acetate |
| Price | price | number | — | yes | Numeric price per unit of sale (per kg, per g, or per pack), excluding currency symbol | 245.00, 1200.00, 38.50 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, INR, CNY, GBP |

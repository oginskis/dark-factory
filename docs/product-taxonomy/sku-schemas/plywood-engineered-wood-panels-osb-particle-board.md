...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or retailer product identifier | RIG-PLY-18-BB, WISA-BIRCH-12, OSB3-1220 |
| Product Name | product_name | text | — | yes | Full product name including brand and variant | Riga Ply, WISA-Birch BB/BB, Edge Gold Enhanced Floor Panel |
| URL | url | text | — | yes | Direct link to the product page or listing | https://example.com/products/riga-ply/ |
| Price | price | number | — | yes | Numeric price value per panel or per unit, no currency symbol | 45.99, 128.50 |
| Currency | currency | text | — | yes | ISO 4217 currency code | EUR, USD, GBP |

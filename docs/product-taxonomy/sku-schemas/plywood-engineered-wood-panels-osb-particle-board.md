...
| Brand | text | Brand or trade name under which the product is sold | Riga Wood, WISA, Edge Gold, Diamond |
...
| Length | number (mm) | Panel length in millimeters | 2440, 2500, 3050, 3660 |
...
| Weight per Panel | number (kg) | Approximate weight of a single panel at standard dimensions | 12.5, 28, 42, 65 |
| Edge Profile | enum | Edge treatment or profile for panel joining | Square edge, Tongue and groove, Shiplap |
| Application | text (list) | Intended end-use applications for the panel | Construction, Formwork, Flooring, Transport, Packaging, Furniture, Marine |
| Anti-Slip Rating | text | Anti-slip classification per DIN 51130 or equivalent | R9, R10, R11, R12, R13 |
| Certifications | text (list) | Product and chain-of-custody certifications | FSC, PEFC, CE, UKCA, EPD |
| Country of Origin | text | Country where the panel was manufactured | Latvia, Finland, Estonia, Germany, Canada, USA |
| Product Line | text | Product series or family name within the brand | Riga Ply, WISA-Birch, Edge Gold, Diamond Premium |

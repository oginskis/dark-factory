...
| Brand | text | Brand or label name on the product | Tyson, Perdue, Cargill, National Beef, Gorton's, Bumble Bee |
...
| Net Weight | number (g) | Net weight of the product contents | 170, 340, 454, 907, 4536, 18144 |
| Portion Weight | number (g) | Weight of an individual portion-controlled piece | 113, 170, 227, 340 |
| Piece Count | number | Number of individual pieces or portions in the package | 1, 2, 4, 8, 40, 100 |
...
| Case Pack | number | Number of selling units per case | 2, 4, 8, 12, 24, 40 |
| Allergen Declaration | text (list) | Major allergens present, particularly for breaded or marinated products | Fish, Shellfish, Wheat, Soy, Milk, Eggs |
| Sustainability Certification | text (list) | Environmental or sustainability certifications | MSC, ASC, BAP, Dolphin Safe, Ocean Wise, Global GAP |
| Antibiotic Free | boolean | Whether the animal was raised without antibiotics | true, false |
| Hormone Free | boolean | Whether the animal was raised without added hormones | true, false |
| Organic | boolean | Whether the product is certified organic | true, false |
| Animal Welfare Certification | text | Animal welfare program certification | GAP Step 1-5+, Certified Humane, Animal Welfare Approved |
| Halal/Kosher | text (list) | Religious dietary certifications | Halal, Kosher |
| HACCP Compliant | boolean | Whether the facility operates under a HACCP food safety plan | true, false |

...
| Brand/Manufacturer | text | Company that manufactured the component | SKF, Timken, NSK, FAG/Schaeffler, NTN, SEW Eurodrive, Rexnord, Martin Sprocket |
...
| Bore Diameter | number (mm) | Inner ring bore diameter for bearings or shaft bore for gears and couplings | 3, 10, 17, 25, 35, 50, 80, 120, 200 |
| Outer Diameter | number (mm) | Outer ring outside diameter for bearings | 10, 26, 47, 62, 80, 110, 180, 400 |
...
| Output Speed | number (rpm) | Rotational speed at the output shaft | 1, 14, 47, 140, 280 |
| Shaft Diameter | number (mm) | Diameter of the output or input shaft | 9, 14, 20, 25, 35, 50, 70, 110 |
...
| Lubrication | text | Lubricant type pre-filled or recommended | Grease (Lithium), Oil Bath, Synthetic Oil, Dry (Self-Lubricating) |
| Operating Temperature Range | text | Permissible temperature range during operation | -20 to 120 C, -30 to 150 C, -40 to 200 C |
| Tolerance Class | text | Dimensional and running accuracy classification | P0 (Normal), P6, P5, P4, P2, ABEC 1, ABEC 5, ABEC 7 |
| Pitch/Module | text | Tooth pitch for gears, chains, and sprockets or belt pitch | Module 1, Module 2, 25.4 mm (1 in), 12.7 mm (0.5 in), 8M, 14M |
| Number of Teeth | number | Count of teeth on a gear or sprocket | 12, 17, 24, 36, 48, 72 |
| Gear Type | text | Classification of gear geometry | Spur, Helical, Bevel, Worm, Planetary, Hypoid |
| Certification | text (list) | Safety and quality certifications | CE, ISO 9001, AGMA, ABMA, RoHS |
| Weight | number (kg) | Net weight of the component | 0.01, 0.15, 2.5, 35.0, 250.0 |

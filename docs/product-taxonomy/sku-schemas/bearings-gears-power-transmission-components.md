...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 6205-2RS1, 32008-X, R133ZZ, SA47DRE80M4 |
| Product Name | product_name | text | — | yes | Full product name including type, series, and key dimensions | SKF 6205-2RS1 Deep Groove Ball Bearing 25x52x15mm, SEW Eurodrive SA47 Helical-Worm Gearmotor |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/6205-2rs1 |
| Price | price | number | — | yes | Numeric unit price excluding currency symbol | 8.50, 42.00, 350.00, 2500.00 |

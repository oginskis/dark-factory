...
| Brand/Manufacturer | text | Name of the head protection manufacturer | MSA, 3M, Honeywell, Pyramex, Bullard, Klein Tools, Milwaukee |
...
| Fits Hat Size | text | Head circumference or hat size range the helmet fits | 6-1/2 to 8, 6-3/8 to 8, One Size |
| Color | text | Shell color | White, Yellow, Orange, Red, Blue, Green, Gray, Hi-Viz Lime |
| Weight | number (g) | Weight of the complete hat or helmet with suspension | 340, 390, 425, 510 |
...
| Series/Product Line | text | Product family or series name | V-Gard, V-Gard H1, SecureFit X5000, SL Series, Skullgard |
| Replacement Interval | text | Recommended shell replacement period | 5 years, 2 years, Per manufacturer UV inspection |

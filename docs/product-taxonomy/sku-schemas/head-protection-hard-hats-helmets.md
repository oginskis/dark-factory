...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | 475362, 10034018, MSA-10204776 |
| Product Name | product_name | text | Full product name including key specs such as type, class, and brim style | MSA V-Gard Full Brim Hard Hat Class E, 3M SecureFit X5000 Series Safety Helmet Type 2 |
| URL | url | text | Direct link to the product page | https://example.com/product/v-gard-full-brim-hard-hat |
| Price | price | number | Numeric unit price excluding currency symbol | 12.50, 34.99, 89.95 |

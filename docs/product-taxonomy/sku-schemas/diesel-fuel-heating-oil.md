...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Supplier or distributor product identifier | CITGO-1DS15, MPC-ULSD-2D, VT-HO2-ULS |
| Product Name | product_name | text | — | yes | Full product name including brand, grade, and sulfur designation | CITGO No. 2 Diesel Ultra-Low Sulfur, Marathon No. 1-D S15 Winter Diesel, Premium Heating Oil No. 2 |
| URL | url | text | — | yes | Direct link to the product data sheet or listing page | https://example.com/fuels/ulsd-no2 |
| Price | price | number | — | yes | Numeric price per gallon or litre at time of listing, excluding currency symbol | 3.49, 3.89, 4.29 |

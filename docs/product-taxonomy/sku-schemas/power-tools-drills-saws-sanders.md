...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or retailer article number uniquely identifying the product | 576721, DCD999B, 2904-20 |
| Product Name | product_name | text | — | yes | Full product name including model designation | Plunge-cut saw TS 60 KEBQ-Plus, 20V MAX 1/2 in. Brushless Cordless Hammer Drill/Driver |
| URL | url | text | — | yes | Direct link to the product page on the manufacturer or retailer site | https://www.festool.com/products/saws/plunge-saws/576721---ts-60-kebq-plus |
| Price | price | number | — | yes | Numeric price value without currency symbol, representing MSRP or list price | 549.00, 199.00, 329.99 |
| Currency | currency | text | — | yes | ISO 4217 currency code for the listed price | USD, EUR, GBP |

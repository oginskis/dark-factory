...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | X5A, 1100, 340-4004, H10A |
| Product Name | product_name | text | — | yes | Full product name including key specs such as type, NRR, and model | 3M PELTOR X5A Over-the-Head Earmuffs NRR 31 dB, Howard Leight MAX Disposable Foam Earplugs NRR 33 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/peltor-x5a-earmuffs |
| Price | price | number | — | yes | Numeric unit price excluding currency symbol | 0.15, 8.99, 54.95, 349.00 |

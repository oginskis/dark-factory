...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Manufacturer catalog or part number | 866471, 2060600-005, HC867030 |
| Product Name | product_name | text | — | Full product name including model and configuration | Philips IntelliVue MX750 Bedside Patient Monitor, GE Healthcare B40 V3 Patient Monitor |
| URL | url | text | — | Direct link to the product page | https://example.com/product/intellivue-mx750 |
| Price | price | number | — | List price or contract price per unit | 5500, 12000, 28000, 65000 |

...
| Brand/Manufacturer | text | IVD manufacturer or brand name | Roche Diagnostics, Abbott, Siemens Healthineers, Beckman Coulter, bioMerieux, Sysmex |
...
| Sample Capacity | number | Number of onboard sample positions (instruments) | 50, 108, 150, 300 |
...
| Weight | number (kg) | Net weight of instrument or shipping weight of kit | 0.5, 2.3, 135, 580 |
| Power Requirements | text | Electrical supply for instruments | 100-240 V AC, 50/60 Hz, 1300 W |
| Connectivity | text (list) | Data interfaces and communication protocols for instruments | LIS (HL7), USB, Ethernet, RS-232, Wi-Fi, ASTM |
| Country of Manufacture | text | Country where the product is produced | Germany, USA, Japan, Ireland |

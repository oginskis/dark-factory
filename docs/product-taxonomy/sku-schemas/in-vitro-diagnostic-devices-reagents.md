...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer catalog or part number | 06531853190, 04489357190, 309589 |
| Product Name | product_name | text | — | yes | Full product name including analyte or system designation | cobas c 311 Analyzer, Roche Cholesterol Gen.2 Reagent, Abbott i-STAT CG4+ Cartridge |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/cobas-c-311 |
| Price | price | number | — | yes | List or catalog price per unit or per kit | 125.00, 450.00, 85000.00 |

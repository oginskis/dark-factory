...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | VF-1200, SVE-2510, CCW-RV-214, MK-GS30 |
| Product Name | product_name | text | — | Full product name including machine type, series, and key capability | Paxiom VF 1200 Continuous Motion VFFS Bagger, Syntegon SVE 2510 Vertical Form Fill Seal Machine, Ishida CCW-RV 14-Head Multihead Weigher |
| URL | url | text | — | Direct link to the product page | https://example.com/product/vf-1200 |
| Price | price | number | — | Numeric unit price excluding currency symbol | 15000, 65000, 250000 |

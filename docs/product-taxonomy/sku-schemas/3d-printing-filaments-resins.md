...
| Brand/Manufacturer | text | Manufacturer or supplier name | Bambu Lab, Hatchbox, Prusament, Formlabs, eSUN, FormFutura, Elegoo, Anycubic |
...
| Filament Diameter | number (mm) | Nominal filament cross-section diameter | 1.75, 2.85 |
| Diameter Tolerance | number (mm) | Manufacturing tolerance on filament diameter | 0.02, 0.03, 0.05 |
| Net Weight | number (g) | Weight of material excluding spool or bottle | 250, 500, 1000, 2000, 5000, 8000 |
...
| Curing Wavelength | number (nm) | UV wavelength for resin curing (resin only) | 365, 385, 395, 405 |
...
| Drying Time | number (h) | Recommended drying duration (filament only) | 4, 6, 8, 12 |
| Certification | text (list) | Safety and environmental certifications | RoHS, REACH, FDA, EN 71-3, ISO 10993 |

...
| Brand/Manufacturer | text | Furniture brand or manufacturer name | IKEA, Ashley Furniture, Pottery Barn, Restoration Hardware, LeisureMod |
...
| Weight Capacity | number (kg) | Maximum recommended user weight | 113, 136, 180, 250 |
...
| Configuration | text | Sectional orientation or modular arrangement | Left-Facing Chaise, Right-Facing Chaise, Symmetrical, L-Shape, U-Shape, Modular |
| Assembly Required | boolean | Whether the product requires assembly by the buyer | true, false |
| Product Weight | number (kg) | Shipping or assembled weight of the piece | 35, 55, 78, 110 |
| Sleeper Mattress Size | text | Mattress size if the sofa converts to a bed | Twin, Full, Queen |
| Warranty | text | Manufacturer warranty duration | 1 Year, 5 Years, 10 Years, Lifetime Frame |
| Country of Origin | text | Country where the piece is manufactured | China, Vietnam, Italy, USA, Poland, Mexico |
| Certification | text (list) | Safety or environmental certifications | CertiPUR-US, GREENGUARD Gold, OEKO-TEX, FSC, BIFMA |

...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or supplier product identifier | KRM-MOD-2500, PNB-GRD-1020, PFX-OFF-340 |
| Product Name | product_name | text | Full product name including key specs such as type, size, and application | Karmod 2-Storey Modular Office 12.5m x 6m, Panel Built 25x71 Prefab Guard House, Prefabex Portable Classroom |
| URL | url | text | Direct link to the product page | https://example.com/product/modular-office-2-storey |
| Price | price | number | Numeric price per unit or per square metre, excluding currency symbol | 18500.00, 45000.00, 125000.00 |
| Currency | currency | text | ISO 4217 currency code | USD, EUR, GBP, TRY, AUD |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | LLBWPRENWOS7, TRX-SEL-PG-16, ADV-IPE-5/4x6 |
| Product Name | product_name | text | — | yes | Full product name including species or collection, size, and finish | Bellawood 5/8in Select White Oak Engineered Hardwood 7.4in Wide, Trex Select Pebble Grey 1x6 16ft |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/white-oak-engineered-7-4 |
| Price | price | number | — | yes | Numeric price per unit (per sq ft, per linear ft, or per piece) excluding currency symbol | 7.64, 3.50, 42.99 |

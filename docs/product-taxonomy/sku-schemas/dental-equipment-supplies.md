...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Manufacturer or distributor catalog number | 1002809, 073-4560, ADC-511-BLK |
| Product Name | product_name | text | — | Full product name including type, brand, and key specification | A-dec 511 Dental Chair, Henry Schein Blu-Mousse VPS Impression Material, Brasseler H48.11.016 Carbide Bur |
| URL | url | text | — | Direct link to the product page | https://example.com/product/a-dec-511-dental-chair |
| Price | price | number | — | Catalog or sale price per unit, pack, or kit | 8.50, 65.00, 4500.00, 18000.00 |

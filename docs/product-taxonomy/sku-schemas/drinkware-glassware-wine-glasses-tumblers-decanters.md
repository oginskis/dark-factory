...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or retailer product identifier, article number, or item number | 6409/07, 9104RL, G1747-09-301 |
| Product Name | product_name | text | — | yes | Full product name including collection and glass type | Heart to Heart Pinot Noir, Vervino All-Purpose Wine Glass, Arc Tumbler 260ml |
| URL | url | text | — | yes | Direct link to the product page | https://www.example.com/shop/product-name |
| Price | price | number | — | yes | Numeric price per selling unit, excluding tax and shipping | 59.00, 102.00, 30.00 |

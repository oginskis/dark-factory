...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | AL6061-T6-125-48X96, 3003-H14-063 |
| Product Name | product_name | text | — | Full product name including alloy, temper, form, and dimensions | 6061-T6 Aluminum Sheet 0.125in x 48in x 96in, 3003-H14 Aluminum Plate 0.250in |
| URL | url | text | — | Direct link to the product page | https://example.com/product/6061-t6-aluminum-sheet |
| Price | price | number | — | Numeric unit price (per piece, per foot, or per pound) excluding currency symbol | 89.50, 12.75, 3.45 |

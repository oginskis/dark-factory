...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | UF-EPS150-2, FBM-EPP13B, AF-XPS200 |
| Product Name | product_name | text | — | yes | Full product name including foam type, density, and dimensions | EPS Foam Board Insulation 2 in x 4 ft x 8 ft 1.5 lb, Polyurethane Expanding Foam 1 lb Density |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/eps-2in-4x8-15lb |
| Price | price | number | — | yes | Numeric price per sheet, block, or unit, excluding currency symbol | 22.50, 48.00, 89.99 |

...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or distributor product identifier | HT-UL142-AST-1000, SC-ASME-SS-500 |
| Product Name | product_name | text | Full product name including type, material, capacity, and certification | UL-142 Double Wall Aboveground Steel Tank 1000 Gallon, ASME 316L Stainless Steel Pressure Vessel 500 Gallon |
| URL | url | text | Direct link to the product page | https://example.com/product/ul142-double-wall-steel-tank-1000gal |
| Price | price | number | Numeric unit price excluding currency symbol | 2500.00, 8500.00, 45000.00 |

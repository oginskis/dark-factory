...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | PVC-040-100, 48740, CP-1120 |
| Product Name | product_name | text | — | yes | Full product name including material, type, schedule, and size | PVC Schedule 40 Pressure Pipe 1 in x 10 ft, CPVC 90-Degree Elbow 3/4 in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/pvc-sch40-1in |
| Price | price | number | — | yes | Numeric price per unit or per foot, excluding currency symbol | 4.98, 12.50, 0.89 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer, wholesaler, or pharmacy product identifier | MCK-4901234, ABC12345, 0003-0894-31 |
| Product Name | product_name | text | — | yes | Full product name including brand or generic name, strength, and dosage form | Eliquis 5 mg Film-Coated Tablets, Metformin HCl ER 500 mg Tablets, Atorvastatin Calcium 20 mg Tablets |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/eliquis-5mg-tablets |
| Price | price | number | — | yes | Numeric price per unit or per package excluding currency symbol | 12.50, 549.99, 0.85 |

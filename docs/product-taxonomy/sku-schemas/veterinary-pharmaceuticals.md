...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Distributor, veterinary supplier, or manufacturer product identifier | ZTS-APQ-16, MRK-NUF-250, ELN-GAL-INJ |
| Product Name | product_name | text | — | yes | Full product name including brand, active ingredient, strength, and dosage form | Apoquel 16 mg Film-Coated Tablets for Dogs, Nuflor 300 mg/mL Solution for Injection, Drontal Plus Taste Tablets for Dogs |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/apoquel-16mg-tablets |
| Price | price | number | — | yes | Numeric price per unit or per package excluding currency symbol | 2.85, 125.00, 45.99 |

...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | H01WPS000, SP_229437, 2498023 |
| Product Name | product_name | text | Full product name including brand, product type, variant, and size | Graco 4Ever DLX 4-in-1 Car Seat, The Honest Company Clean Conscious Wipes, Dr. Browns Natural Flow Bottle 8oz |
| URL | url | text | Direct link to the product page | https://example.com/product/baby-wipes-sensitive |
| Price | price | number | Numeric price per unit or pack, excluding currency symbol | 6.99, 24.99, 249.99 |

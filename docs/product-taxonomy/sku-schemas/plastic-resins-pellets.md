...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or supplier product identifier (often the grade name) | DOW-DMDA-8904, CPChem-HHM-TR144, PPR-HDPE-VN-01 |
| Product Name | product_name | text | — | yes | Full product name including resin type, grade, and key property descriptors | Dow DMDA-8904 NT7 HDPE Blow Molding Resin, Marlex HHM TR-144 High Molecular Weight HDPE, Tipelin BA 550-13 HDPE |
| URL | url | text | — | yes | Direct link to the product page or technical data sheet | https://example.com/products/hdpe-blow-molding-8904 |
| Price | price | number | — | yes | Numeric price per unit (per kg, per lb, or per MT), excluding currency symbol | 1.15, 1450.00, 2.30 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, CNY, INR |

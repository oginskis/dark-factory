...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Supplier catalog number or product identifier | A6283, 109088, 818755, 64-19-7-500ML |
| Product Name | product_name | text | — | Full product name including chemical name, grade, and purity | Acetic Acid glacial ReagentPlus 99%, Ethanol absolute for analysis 99.8%, Methanol HPLC grade 99.9% |
| URL | url | text | — | Direct link to the product page | https://example.com/product/acetic-acid-a6283 |
| Price | price | number | — | Numeric price per package unit excluding currency symbol | 28.50, 75.00, 142.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | MGPK-2XL, EnerC-306-4MWH, MC-CUBE-T-6432 |
| Product Name | product_name | text | — | yes | Full product name including model and capacity designation | Tesla Megapack 2XL, CATL EnerC+ 306 4MWh Container, BYD MC Cube-T 6.4 MWh |
| URL | url | text | — | yes | Direct link to the product page | https://www.tesla.com/megapack |
| Price | price | number | — | yes | Numeric price per unit or per kWh, excluding currency symbol | 1200000, 850000, 180 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, CNY, AUD |

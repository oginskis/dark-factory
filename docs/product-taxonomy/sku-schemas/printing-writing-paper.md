...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | DOM-5462, UPM-FIN-OFC80, HP-CHP910 |
| Product Name | product_name | text | Full product name including grade, weight, and size | Domtar Husky Digital Opaque 60lb Text 8.5x11, UPM Office Copy A4 80gsm White |
| URL | url | text | Direct link to the product page | https://example.com/product/domtar-husky-60lb-text-8-5x11 |
| Price | price | number | Numeric price per ream, carton, or unit excluding currency symbol | 8.99, 42.50, 185.00 |

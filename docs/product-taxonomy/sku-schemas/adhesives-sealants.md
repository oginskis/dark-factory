...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | 2068749, 62-3895-3785-1, MMM-DP420NS |
| Product Name | product_name | text | Full product name including brand, product number, and type descriptor | LOCTITE 577 Thread Sealant 50mL, 3M Scotch-Weld Epoxy Adhesive 2216 B/A Gray, Henkel Teroson MS 930 |
| URL | url | text | Direct link to the product page | https://example.com/product/loctite-577 |
| Price | price | number | Numeric price per sales unit, excluding currency symbol | 34.62, 125.00, 8.99 |

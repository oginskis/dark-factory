...
| Brand | text | Manufacturer or brand name | Oneida, Fortessa, Liberty Tabletop, Christofle, Zwilling |
...
| Set Size | number | Total number of individual pieces in the selling unit | 1, 5, 20, 45, 65 |
...
| Piece Length | number (inches) | Overall length of the individual piece in inches | 6.375, 7.0, 7.375, 8.0, 9.375 |
| Piece Weight | number (oz) | Weight of a single piece in ounces | 1.2, 1.6, 1.9, 2.2, 2.7 |
...
| Case Pack Size | number | Number of selling units per shipping case, relevant for B2B and foodservice orders | 12, 24, 36 |
| Net Weight | number (lbs) | Total weight of the complete set or selling unit in pounds | 2.75, 4.50, 6.81 |

...
| Brand | text | Product brand or manufacturer name | Still Riding Foods, Sysco, Birds Eye, McCain, Tyson, Stouffers |
...
| Total Case Weight | number (kg) | Total net weight of the entire case | 2.72, 9.07, 13.6 |
| Serving Size | text | Labeled serving size with unit | 1 pizza, 85 g, 3/4 cup, 2 pieces |
| Servings Per Container | number | Number of servings per individual unit | 1, 3, 5, 8, 12 |
| Calories Per Serving | number (kcal) | Energy content per serving | 90, 180, 290, 420, 670 |
...
| Shipping Weight | number (kg) | Total weight of the selling unit including packaging for shipping | 3.2, 9.5, 14.1, 16.8 |

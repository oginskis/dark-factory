...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Unique product identifier assigned by the manufacturer or retailer | 303KSE21, 1042392620, 8034-406D |
| Product Name | product_name | text | — | yes | Human-readable name of the dinnerware item, typically including type, size, and collection | 10.5 Coupe Dinner Plate Set of 4, Bright White Square Porcelain Plate 12 in, Matte Slate Round Deep Plate |
| URL | url | text | — | yes | Link to the product page or catalog listing | https://example.com/products/dinner-plate-10 |
| Price | price | number | — | yes | Numeric price value per unit or per set, excluding currency symbol | 24.99, 79.99, 10.33 |
| Currency | currency | text | — | yes | ISO 4217 currency code for the listed price | USD, EUR, GBP, JPY |

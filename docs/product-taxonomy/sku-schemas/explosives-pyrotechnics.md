...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | DYNAP-75, APB-400, TROJAN-RP, NP2028 |
| Product Name | product_name | text | — | yes | Full product name including brand, product line, and key specification | Dyno AP 75mm Cartridge, Austin Powder Hydromite 1100, TROJAN RINGPRIME Cast Booster, Protocol 2028 Barrage |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/dyno-ap-75 |
| Price | price | number | — | yes | Numeric price per sales unit (case, cartridge, each, or kg), excluding currency symbol | 150.00, 2400.00, 45.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, AUD, CAD, ZAR |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | PAJT4720, 1464, 1000029181 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as species, grade, and dimensions | PEFC C24 Regularised Joist Premium Treated Kiln Dried 47 x 200mm, Red Oak 4/4 Lumber S2S |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/c24-carcassing-47x200 |
| Price | price | number | — | yes | Numeric price per unit (piece, board foot, or cubic metre depending on seller), excluding currency symbol | 11.58, 6.99, 224.50 |
| Currency | currency | text | — | yes | ISO 4217 currency code | GBP, USD, EUR, CAD, AUD |

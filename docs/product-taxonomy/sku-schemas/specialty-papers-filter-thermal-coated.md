...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Manufacturer or distributor product identifier | KOE-KT48PF, WHT-1001-090, DOM-TP55, AHL-613 |
| Product Name | product_name | text | — | Full product name including paper type, grade, and key specs | Koehler KT48-PF Phenol-Free Thermal Paper 48gsm, Whatman Grade 1 Qualitative Filter Paper 90mm |
| URL | url | text | — | Direct link to the product page | https://example.com/product/koehler-kt48-pf-thermal |
| Price | price | number | — | Numeric price per roll, per pack, or per ream excluding currency symbol | 12.50, 45.00, 285.00 |

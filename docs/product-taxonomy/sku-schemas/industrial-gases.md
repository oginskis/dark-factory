...
| Cylinder Size | text | Standard cylinder size designation by supplier convention | 20, 40, 50, 60, 80, 125, 150, 200, 250, 300, 50L, K |
...
| Cylinder Diameter | number (mm) | Outside diameter of the cylinder body | 140, 178, 229, 235, 267 |
| Cylinder Length | number (mm) | Overall height of the cylinder including valve | 591, 914, 1320, 1397 |
| Tare Weight | number (kg) | Empty weight of the cylinder and valve | 5.5, 11.8, 27, 45, 60 |
...
| UN Number | text | United Nations number for transportation classification | UN1006, UN1066, UN1013, UN1049, UN1072 |
| Hazard Class | text | DOT/ADR transport hazard classification | 2.2 Non-flammable Gas, 2.1 Flammable Gas, 5.1 Oxidizer |
| Certifications | text (list) | Quality and regulatory certifications for the gas product | ISO 17025, ISO 17034, Pharmacopeia, FDA, CE |

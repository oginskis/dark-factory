...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | AR UHP300, HE 300, NI 200, CO2-50L |
| Product Name | product_name | text | — | yes | Full product name including gas type, grade, supply mode, and size | UHP Grade Argon Size 300 High Pressure Steel Cylinder CGA 580, Industrial Grade Oxygen Size 200 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/ar-uhp300 |
| Price | price | number | — | yes | Numeric price per unit (cylinder, dewar, or per volume), excluding currency symbol | 85.00, 250.00, 1200.00 |

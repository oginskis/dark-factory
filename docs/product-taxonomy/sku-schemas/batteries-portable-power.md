...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Retailer or manufacturer product identifier | MN1500B4, E91BP-4, EF-E1000V2 |
| Product Name | product_name | text | Full product name including key specs such as chemistry, size or capacity, and brand line | Duracell Coppertop AA Alkaline Battery 4-Pack, Jackery Explorer 1000 v2 Portable Power Station |
| URL | url | text | Direct link to the product page | https://example.com/product/coppertop-aa-4pk |
| Price | price | number | Numeric price per unit or pack, excluding currency symbol | 4.99, 29.95, 899.00 |

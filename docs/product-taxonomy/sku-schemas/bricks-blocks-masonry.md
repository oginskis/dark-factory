...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | RCP-8816P, CM-HRZ-8, HD-100002403 |
| Product Name | product_name | text | — | yes | Full product name including type, size, and finish | Standard Concrete Block 8 x 8 x 16, Clay Face Brick King Size Red, Splitface CMU 12 in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/cmu-8x8x16 |
| Price | price | number | — | yes | Numeric price per unit or per thousand, excluding currency symbol | 1.85, 3.50, 650.00 |

...
| Brand/Manufacturer | text | Manufacturer or supplier name | County Materials, RCP Block and Brick, Boral, Acme Brick, Oldcastle APG |
...
| Nominal Length | number (in) | Nominal end-to-end length (includes mortar joint) | 8, 12, 16, 24 |
...
| Actual Length | number (in) | Manufactured length minus mortar allowance | 7.625, 11.625, 15.625 |
| Weight per Unit | number (lb) | Weight of a single masonry unit | 5, 28, 33, 38, 42, 55 |
...
| Pieces per Cube | number | Number of units per banded cube or pallet | 75, 90, 108, 120, 144, 500 |

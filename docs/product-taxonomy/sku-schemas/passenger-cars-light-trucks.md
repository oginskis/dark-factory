...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Manufacturer stock or inventory identifier, often a VIN-based code or dealer stock number | STK-28451, A12345 |
| Product Name | product_name | text | — | Full vehicle name including year, make, model, and trim | 2025 Toyota Camry LE Hybrid, 2025 Ford F-150 XLT SuperCrew 4x4 |
| URL | url | text | — | Direct link to the vehicle listing or product page | https://example.com/inventory/2025-toyota-camry-le |
| Price | price | number | — | Manufacturer suggested retail price or listed sale price | 29495, 42350, 56800 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | KF-2041, ITK-J100, 89012345 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as fiber content, knit type, and weight | Cotton Jersey Knit 180 GSM 60in, Rayon Spandex Interlock Black |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/cotton-jersey-knit-180gsm |
| Price | price | number | — | yes | Numeric price per unit (typically per yard or per metre), excluding currency symbol | 7.99, 14.50, 24.95 |

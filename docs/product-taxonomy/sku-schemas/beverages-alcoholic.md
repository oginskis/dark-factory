...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or distributor product identifier | BEV-70021, 080432400432, RNDC-55120 |
| Product Name | product_name | text | — | yes | Full product name including brand, expression, vintage if applicable, and size | Maker's Mark Kentucky Straight Bourbon Whisky 750ml, Chateau Margaux 2015 750ml, Sierra Nevada Pale Ale 12oz 6-Pack |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/makers-mark-bourbon-750 |
| Price | price | number | — | yes | Numeric price per selling unit (bottle, can, pack, case), excluding currency symbol | 29.99, 12.99, 189.00, 42.50 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, CAD, AUD, JPY |

...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | C9200L-24P-4G-E, R650, UAP-AC-PRO, TL-SG1024 |
| Product Name | product_name | text | — | Full product name including brand, model, port count, and speed tier | Cisco Catalyst 9200L 24-Port PoE+ 4x1G Switch, Ubiquiti UniFi 6 Long-Range Access Point |
| URL | url | text | — | Direct link to the product page | https://example.com/product/c9200l-24p-4g |
| Price | price | number | — | Numeric unit price excluding currency symbol | 149.99, 2895.00, 8750.00 |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 54282-BG28, B07DC8BR3B, H01ODPV2S7 |
| Product Name | product_name | text | — | yes | Full product name including brand, line, type, and size | Pampers Swaddlers Diapers Size 4, TENA ProSkin Super Briefs Large, NorthShore MegaMax Tab-Style Briefs |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/adult-briefs-large |
| Price | price | number | — | yes | Numeric price per package or case, excluding currency symbol | 12.99, 34.50, 89.95 |

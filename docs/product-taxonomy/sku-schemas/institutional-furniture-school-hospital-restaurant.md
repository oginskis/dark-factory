...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 9018, 164A3232BKD, MDS89, ZUM18 |
| Product Name | product_name | text | — | Full product name including series, type, and key dimensions | Virco 9000 Series 4-Leg Stack Chair 18in, Lancaster Alloy 32x32in Outdoor Table with 4 Chairs |
| URL | url | text | — | Direct link to the product page | https://virco.com/product/9000-series-4-leg-stack-chair/ |
| Price | price | number | — | Numeric unit price excluding currency symbol | 89.00, 349.99, 1250.00 |

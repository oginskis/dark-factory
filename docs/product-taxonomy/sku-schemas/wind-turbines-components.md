...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or distributor product identifier | V150-4.2-IEC3B, HAL-X-14MW, SG14-222DD |
| Product Name | product_name | text | Full product name including model designation, rated power, and rotor diameter | Vestas V150-4.2 MW EnVentus, GE Haliade-X 14 MW, Siemens Gamesa SG 14.0-222 DD |
| URL | url | text | Direct link to the product page | https://www.vestas.com/en/energy-solutions/onshore-wind-turbines/enventus-platform/v150-4-2-mw |
| Price | price | number | Numeric price per unit or per kW installed, excluding currency symbol | 3500000, 12000000, 1200 |
| Currency | currency | text | ISO 4217 currency code | USD, EUR, GBP, DKK, CNY |

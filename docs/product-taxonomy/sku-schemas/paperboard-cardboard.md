...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Manufacturer or distributor product identifier | SW-CAND-016, GPI-EVR-018, CWP-NuVo-012 |
| Product Name | product_name | text | — | Full product name including board type, caliper, and coating | Candesce SBS C1S 16pt, PaceSetter CRB Double Coated 18pt, Coated Natural Kraft P1S 22pt |
| URL | url | text | — | Direct link to the product page | https://example.com/product/candesce-sbs-c1s-16pt |
| Price | price | number | — | Numeric price per ton, per MSI (thousand square inches), or per sheet excluding currency symbol | 1250.00, 14.50, 0.085 |

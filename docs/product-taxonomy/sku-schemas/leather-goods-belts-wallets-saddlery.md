...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | HB-TAH-BLK-36, BFC-BIF-BIS, TS-SAD-WRN-16 |
| Product Name | product_name | text | — | yes | Full product name including product type, leather type, and key features | Tahoe Full Grain Bifold Wallet Black, 1.5 inch Bridle Leather Belt with Brass Buckle, Western Roping Saddle 16 inch Seat |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/bridle-leather-belt |
| Price | price | number | — | yes | Numeric price per unit, excluding currency symbol | 45.00, 120.00, 895.00 |

...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 3003591-206, TSC-4412850, PUR-0046612 |
| Product Name | product_name | text | — | Full product name including key specs such as animal type, protein level, form, and weight | Purina Wind and Rain All Season 4 Beef Cattle Mineral Tub 125 lb, DuMOR 16% Protein Livestock Supplement 200 lb |
| URL | url | text | — | Direct link to the product page | https://example.com/product/cattle-mineral-tub-125lb |
| Price | price | number | — | Numeric price per unit (bag, tub, block, pail, or ton), excluding currency symbol | 54.99, 129.99, 18.49, 425.00 |
| Currency | currency | text | — | ISO 4217 currency code | USD, CAD, EUR, GBP, AUD |

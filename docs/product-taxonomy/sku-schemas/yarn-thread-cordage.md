...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | ST-T60-BLK, YRN-WS-100, RC-NY-3/8 |
| Product Name | product_name | text | — | yes | Full product name including key specs such as material, size, and construction | Bonded Nylon Thread Tex 70 Black, 3-Strand Polypropylene Rope 3/8in |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/bonded-nylon-tex70 |
| Price | price | number | — | yes | Numeric price per unit (per spool, skein, cone, or foot), excluding currency symbol | 4.99, 12.50, 85.00, 249.00 |

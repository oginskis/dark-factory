...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | FP-CUB-5PC-CH, 303.118.24, OD-SEC-GRY |
| Product Name | product_name | text | — | Full product name including key specs such as type, material, and seating capacity | Nantucket 5-Piece Teak Dining Set, APPLARO Table 4 Armchairs Outdoor Brown Stained, Montecito Aluminum Sectional Sofa with Sunbrella Cushions |
| URL | url | text | — | Direct link to the product page | https://example.com/product/nantucket-5pc-dining |
| Price | price | number | — | Numeric price per unit or set excluding currency symbol | 249.00, 899.99, 3450.00 |

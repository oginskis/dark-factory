...
| Brand/Manufacturer | text | Brand or manufacturer name | Polywood, Brown Jordan, Florida Patio, IKEA, Pottery Barn, Fermob |
...
| Seating Capacity | number | Recommended number of seated persons | 1, 2, 4, 6, 8 |
...
| Weight Capacity per Seat | number (kg) | Maximum recommended weight per seating position | 113, 136, 158, 227 |
...
| Product Weight | number (kg) | Total weight of the assembled piece or set | 8, 22, 55, 110 |
| Assembly Required | boolean | Whether the product requires assembly by the buyer | true, false |
| Warranty | text | Manufacturer warranty duration | 1 Year, 3 Years, 5 Years, 20 Years, Lifetime |
| Style | text | Design or aesthetic style | Modern, Coastal, Farmhouse, Tropical, Mediterranean, Industrial |
| Certification | text (list) | Safety, environmental, or quality certifications | FSC, BIFMA, GREENGUARD Gold, SCS Recycled Content |

...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | B012, 48280, T320, KC-13135 |
| Product Name | product_name | text | — | yes | Full product name including brand, type, ply, and sheet count | Cascades PRO Select Standard Bath Tissue 1-Ply 1000 Sheets, Scott Hygienic High Capacity Folded Tissue 2-Ply 250 Sheets |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/product/cascades-b012-standard-1ply-1000 |
| Price | price | number | — | yes | Numeric price per case or per unit excluding currency symbol | 45.99, 72.50, 3.25 |

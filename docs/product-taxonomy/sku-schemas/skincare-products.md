...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | 0301871120, P455418, B00F97FHAW |
| Product Name | product_name | text | — | yes | Full product name including brand, line, product type, and size | CeraVe AM Facial Moisturizing Lotion SPF 30 2 fl oz, The Ordinary Niacinamide 10% + Zinc 1% 30ml |
| URL | url | text | — | yes | Direct link to the product page | https://www.cerave.com/skincare/moisturizers/am-facial-moisturizing-lotion-with-sunscreen |
| Price | price | number | — | yes | Numeric unit price excluding currency symbol | 16.99, 7.90, 52.00 |

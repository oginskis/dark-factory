...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or distributor product identifier | 103LANGGFR64, 4900030, BEV-WTR-24PK |
| Product Name | product_name | text | — | Full product name including key descriptors such as flavor, size, and pack configuration | Langers Ruby Red Grapefruit Juice 64 fl. oz. - 8/Case, Coca-Cola Classic 12 oz Can - 24/Case |
| URL | url | text | — | Direct link to the product page | https://example.com/product/grapefruit-juice-64oz |
| Price | price | number | — | Numeric price per selling unit (case, pack, or individual), excluding currency symbol | 39.99, 5.49, 22.95 |

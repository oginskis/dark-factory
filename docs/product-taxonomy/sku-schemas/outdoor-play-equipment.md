...
| Brand/Manufacturer | text | Company that produces the equipment | Gorilla Playsets, Rainbow Play Systems, Sportspower, Lifetime, Backyard Discovery, KidKraft |
...
| Total Weight Capacity | number (lbs) | Maximum combined weight the entire structure can support | 345, 800, 1000, 1100 |
| Per-User Weight Limit | number (lbs) | Maximum weight per individual user on a single component | 100, 115, 150, 220, 400 |
...
| Swing Count | number | Number of swing seats included | 0, 2, 3, 4 |
...
| Slide Length | number (feet) | Length of the slide from top to bottom | 5, 8, 10, 14 |
...
| Trampoline Diameter | number (feet) | Diameter of the jumping surface for trampoline products | 8, 10, 12, 14, 15 |
...
| Product Weight | number (lbs) | Shipping weight of the entire set in packaging | 125, 275, 450, 800 |
...
| Warranty | text | Manufacturer warranty coverage and duration | Lifetime Wood, 5-Year Hardware, 1-Year Accessories, 5-Year Frame |
| Country of Origin | text | Country where the product is manufactured | USA, China, Taiwan |
| UPC | text | Universal Product Code barcode identifier | 870780005058, 752113440012 |

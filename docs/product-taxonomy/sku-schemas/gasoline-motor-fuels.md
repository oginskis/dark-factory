...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Supplier or distributor product identifier | EXX-UNL87, SHL-VPWR93, BP-E15-REG |
| Product Name | product_name | text | — | Full product name including brand, grade, and formulation | Shell V-Power NiTRO+ Premium 93, ExxonMobil Synergy Regular 87, bp Amoco Ultimate 93 |
| URL | url | text | — | Direct link to the product data sheet or listing page | https://example.com/fuels/premium-93 |
| Price | price | number | — | Numeric price per gallon or litre at time of listing, excluding currency symbol | 3.29, 3.89, 4.19 |

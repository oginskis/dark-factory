...
| Length | number (ft) | Member length as cut or standard mill length | 10, 20, 30, 40, 60 |
| Weight per Foot | number (lbs/ft) | Linear weight of the section | 4.1, 8.2, 22, 31, 50, 120 |
| Total Weight | number (lbs) | Total weight of the individual piece | 82, 440, 620, 1500, 4800 |
...
| Mill Test Report | boolean | Whether a mill test report is included for the base material | Yes, No |
| Project/Drawing Reference | text | Reference to structural drawings or project specifications when custom fabricated | Drawing No. S-101, Project Spec Section 05 12 00 |

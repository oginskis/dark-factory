...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Fabricator or distributor product identifier | WF-W8X31-A992-20, STR-COL-HSS6X6-30 |
| Product Name | product_name | text | — | Full product name including section type, size, grade, and length | W8x31 A992 Wide Flange Beam 20ft, HSS 6x6x0.25 A500 Grade B Column 30ft |
| URL | url | text | — | Direct link to the product page | https://example.com/product/w8x31-a992-wide-flange-beam |
| Price | price | number | — | Numeric unit price (per piece, per foot, or per pound) excluding currency symbol | 320.00, 18.50, 0.85 |

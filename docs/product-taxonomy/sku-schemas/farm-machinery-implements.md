...
| Brand | text | Manufacturer or brand name | John Deere, Kubota, Case IH, King Kutter, Land Pride, New Holland, AGCO, Massey Ferguson |
...
| Hitch Lift Capacity | number (kg) | Maximum rear three-point hitch lift capacity | 1447, 2336, 3565, 9072 |
...
| Fuel Tank Capacity | number (L) | Fuel tank volume | 68.1, 142.7, 165.4, 378.5 |
...
| Overall Length | number (mm) | Total length of the machine or implement | 1200, 2540, 4081, 5500 |
| Overall Width | number (mm) | Total width including extremities | 1197, 1524, 2286, 3048 |
| Overall Height | number (mm) | Total height of the machine | 1200, 2400, 2794, 3200 |
| Operating Weight | number (kg) | Weight of the machine or implement ready for use | 286, 630, 3975, 11000 |
| Tire Size Front | text | Front tire or track size designation | 7.5-16, 280/85R24, 380/85R28, 520/85R42 |
| Tire Size Rear | text | Rear tire or track size designation | 16.9-28, 460/85R30, 520/85R38, 710/70R42 |
| Wheelbase | number (mm) | Distance between front and rear axle centers | 1727, 2050, 2350, 2870 |
| Turning Radius | number (m) | Minimum turning radius with brakes or articulation | 3.2, 3.85, 4.5, 6.1 |
| Cab Type | enum | Operator station configuration | Open Station, Cab, Premium Cab, Enclosed Cab with HVAC |
| Noise Level | number (dB) | Sound pressure level at operator ear | 78, 82, 85, 92 |
| Emission Standard | text | Engine emission compliance tier | Tier 4 Final, Stage V, Tier 3, EPA Certified |
| Country of Origin | text | Country where the equipment was manufactured | USA, Japan, India, Italy, Germany, Brazil |
| Warranty | text | Manufacturer warranty terms | 2 year, 5 year powertrain, 6 year/2000 hr |

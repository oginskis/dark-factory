...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or distributor product identifier | CF-A36-OD-5000, IC-316-FLANGE-6IN |
| Product Name | product_name | text | Full product name including process, material, and key dimensions | A36 Open Die Forged Round Bar 5in OD x 120in, 316 Stainless Investment Cast Flange 6in 150# |
| URL | url | text | Direct link to the product page | https://example.com/product/a36-open-die-forged-round |
| Price | price | number | Numeric unit price (per piece or per pound) excluding currency symbol | 450.00, 1250.00, 8.50 |

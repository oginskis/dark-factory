...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Dealer or supplier product identifier | GEM-SAP-OV-215, DIA-RND-100-DVS1, RBY-CSH-350 |
| Product Name | product_name | text | — | yes | Full product name including stone type, shape, weight, and key quality descriptors | Natural Blue Sapphire Oval 2.15 ct, GIA Certified Round Brilliant Diamond 1.00 ct D/VS1, Cushion Ruby 3.50 ct Pigeon Blood |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/gemstones/sapphire-oval-215ct |
| Price | price | number | — | yes | Numeric price per stone or per carat, excluding currency symbol | 150.00, 2500.00, 18000.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | USD, EUR, GBP, JPY, CHF |

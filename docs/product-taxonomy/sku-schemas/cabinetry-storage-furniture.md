...
| Brand/Manufacturer | text | Cabinet or furniture brand name | IKEA, KCD, J and K Cabinetry, Shenandoah, Prepac, Crate and Barrel |
...
| Soft Close | boolean | Whether doors and drawers feature a soft-close damping mechanism | true, false |
| Back Panel Material | text | Material of the rear panel | 3mm HDF, 6mm Plywood, 3mm Fiberboard |
| Toe Kick Height | number (mm) | Height of the recessed base at floor level (kitchen/bath cabinets) | 90, 100, 115 |
| Weight Capacity per Shelf | number (kg) | Maximum recommended load per individual shelf | 13, 20, 30 |
...
| Wall Mountable | boolean | Whether the unit can be mounted to a wall | true, false |
| Wood Species | text | Species of solid wood or veneer used | Maple, Birch, Cherry, Oak, Pine, Hickory, Alder |
| Style | text | Design or aesthetic style | Shaker, Modern, Traditional, Rustic, Transitional, Mid-Century |
| Product Weight | number (kg) | Total weight of the product as shipped or assembled | 12, 28, 45, 70 |
| Certification | text (list) | Environmental, safety, or quality certifications | KCMA Certified, ESP Certified, CARB Phase 2, TSCA Title VI, FSC, GREENGUARD |
| Country of Origin | text | Country where the product is manufactured | China, USA, Canada, Vietnam, Sweden, Poland |
| Collection | text | Named product line or series from the manufacturer | KALLAX, BESTA, Shaker, York, Diamond |

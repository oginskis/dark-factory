...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or manufacturer product identifier | 803.290.18, B36-SS, W3630-GD |
| Product Name | product_name | text | — | Full product name including key specs such as type, material, and dimensions | KALLAX Shelf Unit 4x4 White, Shaker Base Cabinet 36 in Gray, BESTA Storage Combination with Doors 120x42x193 cm |
| URL | url | text | — | Direct link to the product page | https://example.com/product/kallax-shelf-unit |
| Price | price | number | — | Numeric price per unit excluding currency symbol | 89.99, 285.00, 1450.00 |

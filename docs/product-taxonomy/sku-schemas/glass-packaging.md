...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Manufacturer or distributor product identifier | ARD-8018855, SKS-GB-16BRF, OBK-GJ-8OZ |
| Product Name | product_name | text | — | yes | Full product name including capacity, color, shape, and neck finish | 750ml Claret Inspiration Eco Series Flint, 16 oz Amber Boston Round 28-400, 8 oz Clear Wide Mouth Jar 70-450 |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/glass/750ml-claret-flint |
| Price | price | number | — | yes | Numeric price per unit or per case, excluding currency symbol | 0.65, 1.20, 12.25, 48.00 |

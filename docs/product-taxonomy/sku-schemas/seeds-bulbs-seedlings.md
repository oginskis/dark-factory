...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product identifier | EB-TUL-RED-10, JS-TOM-BFT-100, AM-WF-POLLINATOR |
| Product Name | product_name | text | — | yes | Full product name including species, variety, and pack details | Brandywine Heirloom Tomato Seeds 100ct, Darwin Hybrid Red Tulip Bulbs 10-Pack, Sweet Basil Organic Seedling 4-inch Pot |
| URL | url | text | — | yes | Direct link to the product page | https://example.com/products/brandywine-tomato-seeds |
| Price | price | number | — | yes | Numeric price per unit excluding currency symbol | 1.99, 3.49, 12.95, 24.99 |

...
| Brand | text | Seed company or nursery name | Burpee, Johnny's Selected Seeds, Eden Brothers, Gurney's, Jung Seed, Ball Seed, American Meadows |
...
| Net Weight | number (g) | Net weight of seeds or plant material per unit | 0.5, 2, 10, 28, 454 |
| Bulb Size | text (cm) | Circumference measurement of the bulb at its widest point | 8/10, 10/12, 12/14, 14/16 |
...
| Flower Color | text | Primary bloom color for ornamental varieties | Red, Yellow, Pink, White, Purple, Mixed, Blue, Orange |
| Deer Resistant | boolean | Whether the species is typically avoided by deer | true, false |
| Pollinator Friendly | boolean | Whether the plant is known to attract bees, butterflies, or hummingbirds | true, false |
| Planting Season | text | Recommended planting window | Spring, Fall, Spring and Fall, Year-Round Indoors |
| Life Cycle | enum | Duration of the plant growth cycle | Annual, Biennial, Perennial |
| Lot Number | text | Seed testing lot number printed on the packet | A2025-4421, L26-0078 |
| Country of Origin | text | Country where the seed or plant material was produced | USA, Netherlands, Chile, New Zealand, Canada |
| Treated Seed | boolean | Whether the seed has been chemically treated with fungicide or insecticide | true, false |
| Pack Quantity | number | Number of bulbs, seedlings, or bare roots per pack | 1, 3, 5, 10, 25, 50, 100 |

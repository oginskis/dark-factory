...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Manufacturer or dealer stock/inventory number | STK-90214, UNIT-4587 |
| Product Name | product_name | text | Full vehicle name including year, make, model, and configuration | 2025 Freightliner Cascadia 126 Day Cab, 2025 Volvo VNL 760 72-inch Sleeper |
| URL | url | text | Direct link to the vehicle listing or product page | https://example.com/inventory/2025-cascadia-126 |
| Price | price | number | MSRP or listed sale price | 145000, 185000, 275000, 450000 |
| Currency | currency | text | ISO 4217 currency code | USD, EUR, GBP, SEK |

...
|-----------|-----|-----------|-------------|----------------|
| SKU | sku | text | Supplier or trader product identifier | IORE-PEL-67, KIO-LMP-651, VALE-FIN-632 |
| Product Name | product_name | text | Full product name including form, grade, and key specs | LKAB Blast Furnace Pellets 67% Fe, Kumba Premium Lump 65.1% Fe, Pilbara Blend Fines 62% Fe |
| URL | url | text | Direct link to the product page | https://example.com/products/iron-ore-pellets |
| Price | price | number | Numeric price per dry metric tonne, excluding currency symbol | 120.50, 98.75, 145.00 |
| Currency | currency | text | ISO 4217 currency code | USD, EUR, CNY, AUD |

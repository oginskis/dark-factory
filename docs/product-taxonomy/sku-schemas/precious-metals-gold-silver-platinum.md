...
|--------|--------|--------|--------|--------|--------|
| SKU | sku | text | — | Retailer or dealer product identifier | AGE-1OZ-2025, SML-1OZ-BU, PAMP-1OZ-BAR |
| Product Name | product_name | text | — | Full product name including metal, weight, mint, and year | 2025 1 oz American Gold Eagle BU, 1 oz PAMP Suisse Platinum Bar .9995 Fine |
| URL | url | text | — | Direct link to the product page | https://example.com/product/2025-1oz-american-gold-eagle |
| Price | price | number | — | Numeric unit price excluding currency symbol. Precious metals prices fluctuate with spot price | 2045.00, 31.50, 1025.00 |

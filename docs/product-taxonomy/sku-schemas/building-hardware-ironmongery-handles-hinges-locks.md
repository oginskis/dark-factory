...
|--------|--------|--------|--------|-----------|--------|--------|
| SKU | sku | text | — | yes | Retailer or manufacturer product code for the hardware item | 14854, HH-LR-SN-102, YAL-PBS2-CH |
| Product Name | product_name | text | — | yes | Full product name including type, range, finish and size | Grade 13 Ball Bearing Fire Door Hinge Satin Finish, Sintra Lever on Rose Door Handle Pair Polished Chrome |
| URL | url | text | — | yes | Direct link to the product page | https://www.example.com/grade-13-ball-bearing-hinge |
| Price | price | number | — | yes | Numeric price value without currency symbol, typically per unit or per pack | 8.49, 24.99, 112.00 |
| Currency | currency | text | — | yes | ISO 4217 currency code | GBP, EUR, USD |
